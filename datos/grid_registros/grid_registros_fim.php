...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["tangara_____grid_registros"]))
   {
      unset($_SESSION['session_sec_aplicacao']["tangara_____grid_registros"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_registros']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_registros']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_registros']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_registros']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_registros']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_registros']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_registros']['embutida_filho'] as $ind => $sc_init)
          {
