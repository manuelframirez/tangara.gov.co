<?php
   ...
   session_start();
    $Ord_Cmp = new grid_indicadores_1_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_indicadores_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["dimension_id_dimension"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['labels']["dimension_id_dimension"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['labels']["dimension_id_dimension"] : "Id Dimension";
   ...
   $tab_labels["dimension_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['labels']["dimension_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['labels']["dimension_descripcion"] : "Descripcion";
   ...
   $tab_labels["tematica_id_tematica"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['labels']["tematica_id_tematica"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['labels']["tematica_id_tematica"] : "Id Tematica";
   ...
   $tab_labels["tematica_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['labels']["tematica_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['labels']["tematica_descripcion"] : "Descripcion";
   ...
   $tab_labels["indicadores_id_indicadores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['labels']["indicadores_id_indicadores"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['labels']["indicadores_id_indicadores"] : "Id Indicadores";
   ...
   $tab_labels["indicadores_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['labels']["indicadores_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['labels']["indicadores_nombre"] : "Nombre";
   ...
   $tab_labels["variables_id_variable"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['labels']["variables_id_variable"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['labels']["variables_id_variable"] : "Id Variable";
   ...
   $tab_labels["variables_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['labels']["variables_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['labels']["variables_descripcion"] : "Descripcion";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       $ordem = (substr($campo_sort, 0, 1) == "+") ? "asc" : "desc";
       $campo = substr($campo_sort, 1);
       $_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['ordem_select'][$campo] = $ordem;
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_indicadores_1_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_indicadores_1']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
