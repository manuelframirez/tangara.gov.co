...
class grid_indicadores_1_xls
{
   ...
   var $tit_doc;
   //---- 
   function grid_indicadores_1_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".xls";
      $this->tit_doc    = "grid_indicadores_1.xls";
...
$_SESSION['scriptcase']['grid_indicadores_1']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1']['xls_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1']['xls_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1']['xls_name']);
          $this->xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1']['xls_file']);
      if (is_file($this->xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1']['xls_file'] = $this->xls_f;
      }
?>
