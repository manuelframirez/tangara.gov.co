...
class treemenu_form_php
{
   ...
   function init()
   {
      ...
      //check prod
      if(!isset($_SESSION['scriptcase']['treemenu']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['treemenu']['glo_nm_path_prod']))
      {
...
<?php
      ...
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['treemenu'] as $id_item => $arr_item)
         {
      ...
      {
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "grid_registros")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_registros") . "/?nm_run_menu=1&nm_apl_menu=treemenu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "grid_registro_municipios_mas_consultado")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_registro_municipios_mas_consultado") . "/?nm_run_menu=1&nm_apl_menu=treemenu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "grid_registro_indicador_mas_consultado")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_registro_indicador_mas_consultado") . "/?nm_run_menu=1&nm_apl_menu=treemenu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "form_acerca_tangara")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_acerca_tangara") . "/?nm_run_menu=1&nm_apl_menu=treemenu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "form_acerca_cauca")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_acerca_cauca") . "/?nm_run_menu=1&nm_apl_menu=treemenu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "menu")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("menu") . "/?nm_run_menu=1&nm_apl_menu=treemenu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "menu_admin")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("menu_admin") . "/?nm_run_menu=1&nm_apl_menu=treemenu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="treemenu"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "treemenu")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'treemenu', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
SC_dir_app_ini('tangara');
$controle = new treemenu_form_php();
$controle->init();
?>
