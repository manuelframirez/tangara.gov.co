  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_acerca_cauca" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_acerca_cauca_validate_acerca_cauca()
  {
    var nomeCampo_acerca_cauca = "acerca_cauca";
    var var_acerca_cauca = scAjaxGetFieldEditorHtml(nomeCampo_acerca_cauca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_acerca_cauca_validate_acerca_cauca(var_acerca_cauca, var_script_case_init, do_ajax_form_acerca_cauca_validate_acerca_cauca_cb);
  } // do_ajax_form_acerca_cauca_validate_acerca_cauca

  function do_ajax_form_acerca_cauca_validate_acerca_cauca_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_acerca_cauca_validate_acerca_cauca_cb
  // ---------- Form
  function do_ajax_form_acerca_cauca_submit_form()
  {
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_acerca_cauca_submit_form(var_acerca_cauca, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_acerca_cauca_submit_form_cb);
  } // do_ajax_form_acerca_cauca_submit_form

  function do_ajax_form_acerca_cauca_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_acerca_cauca_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_acerca_cauca_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_acerca_cauca_navigate_form(var_id_contenido, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_acerca_cauca_navigate_form_cb);
  } // do_ajax_form_acerca_cauca_navigate_form

  function do_ajax_form_acerca_cauca_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_acerca_cauca_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_acerca_cauca_navigate_form_cb
