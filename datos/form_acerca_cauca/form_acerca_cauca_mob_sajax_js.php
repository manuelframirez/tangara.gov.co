  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_acerca_cauca_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate acerca_cauca
  function do_ajax_form_acerca_cauca_mob_validate_acerca_cauca()
  {
    var nomeCampo_acerca_cauca = "acerca_cauca";
    var var_acerca_cauca = scAjaxGetFieldEditorHtml(nomeCampo_acerca_cauca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_acerca_cauca_mob_validate_acerca_cauca(var_acerca_cauca, var_script_case_init, do_ajax_form_acerca_cauca_mob_validate_acerca_cauca_cb);
  } // do_ajax_form_acerca_cauca_mob_validate_acerca_cauca

  function do_ajax_form_acerca_cauca_mob_validate_acerca_cauca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "acerca_cauca";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_acerca_cauca_mob_validate_acerca_cauca_cb
  // ---------- Form
  function do_ajax_form_acerca_cauca_mob_submit_form()
  {
    scAjaxHideMessage();
    var var_acerca_cauca = scAjaxGetFieldEditorHtml("acerca_cauca");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_acerca_cauca_mob_submit_form(var_acerca_cauca, var_id_contenido, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_acerca_cauca_mob_submit_form_cb);
  } // do_ajax_form_acerca_cauca_mob_submit_form

  function do_ajax_form_acerca_cauca_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("acerca_cauca");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_acerca_cauca_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_acerca_cauca_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_acerca_cauca_mob_navigate_form(var_id_contenido, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_acerca_cauca_mob_navigate_form_cb);
  } // do_ajax_form_acerca_cauca_mob_navigate_form

  function do_ajax_form_acerca_cauca_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_acerca_cauca_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_acerca_cauca_mob_navigate_form_cb
  ...
  ajax_field_list[0] = "acerca_cauca";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "acerca_cauca": {"label": "Acerca del Cauca", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "acerca_cauca": new Array()
  };
  ajax_field_mult["acerca_cauca"][1] = "acerca_cauca";

  var ajax_field_id = {
    "acerca_cauca": new Array("hidden_field_label_acerca_cauca", "hidden_field_data_acerca_cauca")
  };
