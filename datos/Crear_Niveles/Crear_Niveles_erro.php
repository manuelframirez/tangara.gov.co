...
$old_error_handler = set_error_handler("Crear_Niveles_scriptcase_error_handler");

function Crear_Niveles_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['Crear_Niveles']['contr_erro']) && $_SESSION['scriptcase']['Crear_Niveles']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_Crear_Niveles->contr_Crear_Niveles->Apl_com_erro = true;
            if ($inicial_Crear_Niveles->contr_Crear_Niveles->NM_ajax_flag)
            {
                $inicial_Crear_Niveles->contr_Crear_Niveles->NM_ajax_info['errList']['geral_Crear_Niveles'][] = $msg;
                return;
            }
            Crear_Niveles_scriptcase_error_display($msg, $err_no);
        }
...
function Crear_Niveles_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['Crear_Niveles'])  && '' != $_SESSION['scriptcase']['error_icon']['Crear_Niveles'])  ? $_SESSION['scriptcase']['error_icon']['Crear_Niveles']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['Crear_Niveles']) && '' != $_SESSION['scriptcase']['error_close']['Crear_Niveles']) ? $_SESSION['scriptcase']['error_close']['Crear_Niveles'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['Crear_Niveles']) && '' != $_SESSION['scriptcase']['error_span_title']['Crear_Niveles']) ? $_SESSION['scriptcase']['error_span_title']['Crear_Niveles'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['Crear_Niveles']) && '' != $_SESSION['scriptcase']['error_icon_title']['Crear_Niveles']) ? $_SESSION['scriptcase']['error_icon_title']['Crear_Niveles'] : '';
?>
