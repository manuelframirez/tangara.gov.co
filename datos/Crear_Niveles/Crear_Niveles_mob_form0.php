...
<?php
include_once("Crear_Niveles_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('Crear_Niveles_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['recarga'];
}
?>
...
<?php
 include_once("Crear_Niveles_mob_js0.php");
?>
...
<input type=hidden name="id_indicadores" value="<?php  echo NM_encode_input($this->id_indicadores) ?>">
<input type=hidden name="_sc_force_mobile" id="sc-id-mobile-control" value="" />
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['Crear_Niveles_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['Crear_Niveles_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['fast_search'][2] : "";
?> 
...
<?php echo nmButtonOutput($this->arr_buttons, "bincluir", "nm_atualiza ('incluir');", "nm_atualiza ('incluir');", "sc_b_ins_t", "", "Siguiente", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "group_2_t");?>
  </div>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_dimension" style="<?php echo $sStyleHidden_dimension; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_dimension"><?php echo $this->nm_new_label['dimension']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_dimension_dumb = ('' == $sStyleHidden_dimension) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_dimension_dumb" style="<?php echo $sStyleHidden_dimension_dumb; ?>"></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_fk_tematica" style="<?php echo $sStyleHidden_fk_tematica; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_fk_tematica"><?php echo $this->nm_new_label['fk_tematica']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['php_cmp_required']['fk_tematica']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['php_cmp_required']['fk_tematica'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_fk_tematica_dumb = ('' == $sStyleHidden_fk_tematica) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fk_tematica_dumb" style="<?php echo $sStyleHidden_fk_tematica_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_fk_tipo_categoria" style="<?php echo $sStyleHidden_fk_tipo_categoria; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_fk_tipo_categoria"><?php echo $this->nm_new_label['fk_tipo_categoria']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_fk_tipo_categoria_dumb = ('' == $sStyleHidden_fk_tipo_categoria) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fk_tipo_categoria_dumb" style="<?php echo $sStyleHidden_fk_tipo_categoria_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['Lookup_nivel'][] = '1'; ?>
 <option value="2" <?php  if ($this->nivel == "2") { echo " selected" ;} ?>>Nivel 2</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['Lookup_nivel'][] = '2'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_nombre" style="<?php echo $sStyleHidden_nombre; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_nombre"><?php echo $this->nm_new_label['nombre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['php_cmp_required']['nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['php_cmp_required']['nombre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['Crear_Niveles_mob']['total'] + 1)?>);</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("Crear_Niveles_mob");
 parent.scAjaxDetailHeight("Crear_Niveles_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
