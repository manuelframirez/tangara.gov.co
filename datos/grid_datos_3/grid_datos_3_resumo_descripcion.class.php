...
class grid_datos_3_resumo
{
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_categoria_nombre;
   var $array_total_variables2_descripcion;
   ...
   var $count_ger;
   var $sum_datos_valor;
   var $sc_proc_quebra_categoria_nombre;
   var $count_categoria_nombre;
   var $sum_categoria_nombre_datos_valor;
   var $sc_proc_quebra_variables2_descripcion;
   var $count_variables2_descripcion;
   var $sum_variables2_descripcion_datos_valor;
   var $sc_proc_quebra_variables1_descripcion;
   var $count_variables1_descripcion;
   var $sum_variables1_descripcion_datos_valor;
   var $sc_proc_quebra_variables_descripcion;
   var $count_variables_descripcion;
   var $sum_variables_descripcion_datos_valor;

   //---- 
   function grid_datos_3_resumo($tipo = "")
   {
      ...
      $this->array_total_categoria_nombre       = array();
      $this->array_total_variables2_descripcion = array();
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_datos_3']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_datos_3']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_datos_3']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("grid_datos_3", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['contr_total_geral'] == "OK")
      {
          $this->array_total_categoria_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['arr_total']['categoria_nombre'];
          $this->array_total_variables2_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['arr_total']['variables2_descripcion'];
          $this->array_total_variables1_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['arr_total']['variables1_descripcion'];
          $this->array_total_variables_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['arr_total']['variables_descripcion'];
      }
      else
      {
          $this->array_total_categoria_nombre = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['arr_total']['categoria_nombre'] = $this->array_total_categoria_nombre;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['arr_total']['variables2_descripcion'] = $this->array_total_variables2_descripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['arr_total']['variables1_descripcion'] = $this->array_total_variables1_descripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['arr_total']['variables_descripcion'] = $this->array_total_variables_descripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       $this->comp_field_nm = array(
           'categoria_nombre' => 0,
           'variables2_descripcion' => 1,
           'variables1_descripcion' => 2,
           'variables_descripcion' => 3,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['summarizing_fields_control'] = array(
               'datos_valor' => array(
                   'label' => " ",
                   'options' => array(
                       array('op' => 'S', 'index' => '2', 'label' => "" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "", 'abbrev' => "Sum"),
                   ),
                   'select' => "<select class=\"sc-ui-select-datos_valor\" onChange=\"scSummChange($(this))\"><option value=\"2\" class=\"sc-ui-select-option-S\">" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "</option></select>",
               ),
           );
       }
       //-----
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "datos_valor", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "res_datos_valor_sum",
       );

       //-----
       foreach ($this->array_total_categoria_nombre as $i_categoria_nombre => $d_categoria_nombre) {
           if (!in_array($i_categoria_nombre, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_categoria_nombre[3] ] = $d_categoria_nombre[2];
               $this->comp_label[0][ $d_categoria_nombre[3] ] = $d_categoria_nombre[2];
           }
           foreach ($this->array_total_variables2_descripcion[$i_categoria_nombre] as $i_variables2_descripcion => $d_variables2_descripcion) {
               if (!in_array($i_variables2_descripcion, $this->comp_label[1][ $d_categoria_nombre[3] ], true)) {
                   $this->comp_index[1][ $d_variables2_descripcion[3] ] = $d_variables2_descripcion[2];
                   $this->comp_label[1][ $d_categoria_nombre[3] ][ $d_variables2_descripcion[3] ] = $d_variables2_descripcion[2];
               }
               foreach ($this->array_total_variables1_descripcion[$i_categoria_nombre][$i_variables2_descripcion] as $i_variables1_descripcion => $d_variables1_descripcion) {
                   if (!in_array($i_variables1_descripcion, $this->comp_label[2][ $d_categoria_nombre[3] ][ $d_variables2_descripcion[3] ], true)) {
                       $this->comp_index[2][ $d_variables1_descripcion[3] ] = $d_variables1_descripcion[2];
                       $this->comp_label[2][ $d_categoria_nombre[3] ][ $d_variables2_descripcion[3] ][ $d_variables1_descripcion[3] ] = $d_variables1_descripcion[2];
                   }
                   foreach ($this->array_total_variables_descripcion[$i_categoria_nombre][$i_variables2_descripcion][$i_variables1_descripcion] as $i_variables_descripcion => $d_variables_descripcion) {
                       if (!in_array($i_variables_descripcion, $this->comp_label[3][ $d_categoria_nombre[3] ][ $d_variables2_descripcion[3] ][ $d_variables1_descripcion[3] ], true)) {
                           $this->comp_index[3][ $d_variables_descripcion[3] ] = $d_variables_descripcion[2];
                           $this->comp_label[3][ $d_categoria_nombre[3] ][ $d_variables2_descripcion[3] ][ $d_variables1_descripcion[3] ][ $d_variables_descripcion[3] ] = $d_variables_descripcion[2];
                       }
                   }
               }
           }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'categoria.Nombre', 'prot' => '@aspass@'),
           array('name' => 'variables2.descripcion', 'prot' => '@aspass@'),
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_tabular'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_categoria_nombre => $l_categoria_nombre) {
           if (isset($this->array_total_categoria_nombre[$i_categoria_nombre])) {
               $this->comp_group[$i_categoria_nombre] = array();
           }
           foreach ($this->comp_label[1][$i_categoria_nombre] as $i_variables2_descripcion => $l_variables2_descripcion) {
               if (isset($this->array_total_variables2_descripcion[$i_categoria_nombre][$i_variables2_descripcion])) {
                   $this->comp_group[$i_categoria_nombre][$i_variables2_descripcion] = array();
               }
               foreach ($this->comp_label[2][$i_categoria_nombre][$i_variables2_descripcion] as $i_variables1_descripcion => $l_variables1_descripcion) {
                   if (isset($this->array_total_variables1_descripcion[$i_categoria_nombre][$i_variables2_descripcion][$i_variables1_descripcion])) {
                       $this->comp_group[$i_categoria_nombre][$i_variables2_descripcion][$i_variables1_descripcion] = array();
                   }
                   foreach ($this->comp_label[3][$i_categoria_nombre][$i_variables2_descripcion][$i_variables1_descripcion] as $i_variables_descripcion => $l_variables_descripcion) {
                       if (isset($this->array_total_variables_descripcion[$i_categoria_nombre][$i_variables2_descripcion][$i_variables1_descripcion][$i_variables_descripcion])) {
                           $this->comp_group[$i_categoria_nombre][$i_variables2_descripcion][$i_variables1_descripcion][$i_variables_descripcion] = array();
                       }
                   }
               }
           }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_categoria_nombre;
       }
       elseif (1 == $level) {
           $return = $this->array_total_variables2_descripcion;
       }
       elseif (2 == $level) {
   ...
   private function ValidarCeros($Datos)
   {
       for($i=0;$i<count($Datos);$i++)
       {
            for($j=0;$j<count($Datos[$i]);$j++)
            {
                if($Datos[$i][$j]['level']===-1)
                {
				
                    if(($Datos[$i][$j]['value']===0))
                    {
                        $Datos[$i][$j]['value']='-';
                    }
					else
					{
						$Valor=$Datos[$i][$j]['value'];
						$Valor=str_replace(',00','',$Valor);
						$Datos[$i][$j]['value']=$Valor;
					}
                }
   ...
   function getYAxys()
   {
       ...
       $this->addYChildrenData($a_axys, $a_data, $i_row, 0, array(), array());
		$a_data=$this->ValidarCeros($a_data);
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['pivot_charts'] = $this->comp_chart_data;
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_grid_datos_3_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_grid_datos_3_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function drawMatrixLabels()
   {
       ...
       $apl_cab_resumo = "" . $_SESSION['Resumen'] . "";
   ...
   function formatValue($total, $valor_campo)
   {
       if ($total == 1)
       {
           nmgp_Form_Num_Val($valor_campo, ".", ",", "2", "N", "2", "", "N:2", "-");
       }
	   if(strpos($valor_campo,',00'))
	   {
			$valor_campo=str_replace(',00','',$valor_campo);
	   }
       return $valor_campo;
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_datos_3']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_datos_3']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_datos_3']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_datos_3']) . "_";
               } 
           }
       }
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "grid_datos_3_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['print_all'];
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['opcao'] = "print";
      ...
      $this->total   = new grid_datos_3_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_descripcion("res", $this->array_total_categoria_nombre, $this->array_total_variables2_descripcion, $this->array_total_variables1_descripcion, $this->array_total_variables_descripcion);
      ksort($this->array_total_categoria_nombre);
      ksort($this->array_total_variables2_descripcion);
...
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
      ...
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $_SESSION['Header_tangara'] . "</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['doc_word'])
{
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_datos_3_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_datos_3_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_datos_3_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" <style type=\"text/css\">\r\n");
       ...
       $nm_saida->saida(" .res_datos_valor_sum_label { text-align: center; vertical-align: middle }\r\n");
       $nm_saida->saida(" .res_datos_valor_sum_field { text-align: center; vertical-align: middle }\r\n");
      $nm_saida->saida(" </style>\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['opcao'] == "pdf")
      { 
              $nm_saida->saida("  <div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $_SESSION['Resumen'] . "</H1></div>\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['embutida'])
      {
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_datos_3/grid_datos_3_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_datos_3/grid_datos_3_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=pb&papel=1&orientacao=1&bookmarks=XX&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&language=es&conf_socor=N&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "document.Fdoc_word.submit()", "document.Fdoc_word.submit()", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
         $nm_saida->saida("     </TD> \r\n");
         $nm_saida->saida("     <TD class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"right\">\r\n");
         if (is_file("grid_datos_3_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_datos_3_help.txt"); 
...
{ 
       ...
       $nm_saida->saida("  tb_show('', 'grid_datos_3_config_pivot.php?nome_apl=grid_datos_3&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("  <input type=\"hidden\" name=\"nmgp_cor_word\" value=\"PB\"/> \r\n");
   ...
   $nm_saida->saida(" }\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grid_datos_3/grid_datos_3_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  {\r\n");
      $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "grid_datos_3/grid_datos_3_iframe.php?scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_datos_3_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['num_css'] . '.css', 'a');
           @fwrite($NM_css, " .res_NM_Count__field { text-align: right }\r\n");
           @fwrite($NM_css, " .res_datos_valor_sum_label { text-align: center; vertical-align: middle }\r\n");
           @fwrite($NM_css, " .res_datos_valor_sum_field { text-align: center; vertical-align: middle }\r\n");
           @fclose($NM_css);
       }
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['print_all'];
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
   ...
   function monta_cabecalho()
   {
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $variables1_descripcion = $Busca_temp['variables1_descripcion']; 
          $tmp_pos = strpos($variables1_descripcion, "##@@");
          if ($tmp_pos !== false)
          {
              $variables1_descripcion = substr($variables1_descripcion, 0, $tmp_pos);
          }
          $variables_descripcion = $Busca_temp['variables_descripcion']; 
          $tmp_pos = strpos($variables_descripcion, "##@@");
          if ($tmp_pos !== false)
          {
              $variables_descripcion = substr($variables_descripcion, 0, $tmp_pos);
          }
          $categoria_nombre = $Busca_temp['categoria_nombre']; 
          $tmp_pos = strpos($categoria_nombre, "##@@");
          if ($tmp_pos !== false)
          {
              $categoria_nombre = substr($categoria_nombre, 0, $tmp_pos);
          }
          $datos_valor = $Busca_temp['datos_valor']; 
          $tmp_pos = strpos($datos_valor, "##@@");
          if ($tmp_pos !== false)
          {
              $datos_valor = substr($datos_valor, 0, $tmp_pos);
          }
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['cond_pesq'], 0, $trab_pos);
      ...
      $nm_saida->saida("    	<tr>\r\n");
      $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>" . $_SESSION['Header_tangara'] . "</span></td>\r\n");
   ...
   function monta_rodape()
   {
      ...
      $nm_cab_filtro   = ""; 
      $nm_cab_filtrobr = ""; 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['campos_busca']))
      { 
        $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['campos_busca'];
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
      ...
      $nm_saida->saida("    <tr>\r\n");
      $nm_saida->saida("        <td>\r\n");
      $nm_saida->saida("            <span class=\"" . $this->css_scGridFooterFont . "\" id=\"rod_col1\">" . "" . $_SESSION['Foot_tangara'] . "" . "</span>\r\n");
      $nm_saida->saida("        </td>\r\n");
      $nm_saida->saida("        <td>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_datos_valor, $quebra_categoria_nombre, $quebra_variables2_descripcion, $quebra_variables1_descripcion, $quebra_variables_descripcion, $quebra_categoria_nombre_orig, $quebra_variables2_descripcion_orig, $quebra_variables1_descripcion_orig, $quebra_variables_descripcion_orig)
   {
      //----- Nombre
      if (!isset($this->array_total_categoria_nombre[$quebra_categoria_nombre_orig]))
      {
         $this->array_total_categoria_nombre[$quebra_categoria_nombre_orig][0] = 1;
         $this->array_total_categoria_nombre[$quebra_categoria_nombre_orig][1] = $sum_datos_valor;
         $this->array_total_categoria_nombre[$quebra_categoria_nombre_orig][2] = $quebra_categoria_nombre;
         $this->array_total_categoria_nombre[$quebra_categoria_nombre_orig][3] = $quebra_categoria_nombre_orig;
      }
      else
      {
         $this->array_total_categoria_nombre[$quebra_categoria_nombre_orig][0]++;
         $this->array_total_categoria_nombre[$quebra_categoria_nombre_orig][1] += $sum_datos_valor;
      }
      //----- Descripcion
      if (!isset($this->array_total_variables2_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig]))
      {
         $this->array_total_variables2_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][0] = 1;
         $this->array_total_variables2_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][1] = $sum_datos_valor;
         $this->array_total_variables2_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][2] = $quebra_variables2_descripcion;
         $this->array_total_variables2_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][3] = $quebra_variables2_descripcion_orig;
      }
      else
      {
         $this->array_total_variables2_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][0]++;
         $this->array_total_variables2_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][1] += $sum_datos_valor;
      }
      //----- Descripcion
      if (!isset($this->array_total_variables1_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][$quebra_variables1_descripcion_orig]))
      {
         $this->array_total_variables1_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][$quebra_variables1_descripcion_orig][0] = 1;
         $this->array_total_variables1_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][$quebra_variables1_descripcion_orig][1] = $sum_datos_valor;
         $this->array_total_variables1_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][$quebra_variables1_descripcion_orig][2] = $quebra_variables1_descripcion;
         $this->array_total_variables1_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][$quebra_variables1_descripcion_orig][3] = $quebra_variables1_descripcion_orig;
      }
      else
      {
         $this->array_total_variables1_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][$quebra_variables1_descripcion_orig][0]++;
         $this->array_total_variables1_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][$quebra_variables1_descripcion_orig][1] += $sum_datos_valor;
      }
      //----- Descripcion
      if (!isset($this->array_total_variables_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][$quebra_variables1_descripcion_orig][$quebra_variables_descripcion_orig]))
      {
         $this->array_total_variables_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][$quebra_variables1_descripcion_orig][$quebra_variables_descripcion_orig][0] = 1;
         $this->array_total_variables_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][$quebra_variables1_descripcion_orig][$quebra_variables_descripcion_orig][1] = $sum_datos_valor;
         $this->array_total_variables_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][$quebra_variables1_descripcion_orig][$quebra_variables_descripcion_orig][2] = $quebra_variables_descripcion;
         $this->array_total_variables_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][$quebra_variables1_descripcion_orig][$quebra_variables_descripcion_orig][3] = $quebra_variables_descripcion_orig;
      }
      else
      {
         $this->array_total_variables_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][$quebra_variables1_descripcion_orig][$quebra_variables_descripcion_orig][0]++;
         $this->array_total_variables_descripcion[$quebra_categoria_nombre_orig][$quebra_variables2_descripcion_orig][$quebra_variables1_descripcion_orig][$quebra_variables_descripcion_orig][1] += $sum_datos_valor;
      }
   }
...
$_SESSION['scriptcase']['grid_datos_3']['contr_erro'] = 'off'; 
     ...
     { 
         $nmgp_select = "SELECT `variables1`.`descripcion` as variables1_descripcion, `variables`.`descripcion` as variables_descripcion, `categoria`.`Nombre` as categoria_nombre, `datos`.`Valor` as datos_valor, `variables2`.`descripcion` as variables2_descripcion from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT `variables1`.`descripcion` as variables1_descripcion, `variables`.`descripcion` as variables_descripcion, `categoria`.`Nombre` as categoria_nombre, `datos`.`Valor` as datos_valor, `variables2`.`descripcion` as variables2_descripcion from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['where_pesq']; 
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->variables1_descripcion = $rs_res->fields[0] ;  
            $this->variables_descripcion = $rs_res->fields[1] ;  
            $this->categoria_nombre = $rs_res->fields[2] ;  
            $this->datos_valor = $rs_res->fields[3] ;  
            $this->variables2_descripcion = $rs_res->fields[4] ;  
            $this->categoria_nombre_orig = $this->categoria_nombre;
            $this->variables2_descripcion_orig = $this->variables2_descripcion;
            $this->variables1_descripcion_orig = $this->variables1_descripcion;
            $this->variables_descripcion_orig = $this->variables_descripcion;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->datos_valor, $this->categoria_nombre, $this->variables2_descripcion, $this->variables1_descripcion, $this->variables_descripcion, $this->categoria_nombre_orig,  $this->variables2_descripcion_orig,  $this->variables1_descripcion_orig,  $this->variables_descripcion_orig);
            }
   }
//
