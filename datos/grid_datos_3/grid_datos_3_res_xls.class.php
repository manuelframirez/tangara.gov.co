...
class grid_datos_3_res_xls
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= "_grid_datos_3";
      $this->arquivo   .= ".xls";
      $this->tit_doc    = "grid_datos_3.xls";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['xls_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['xls_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['xls_name']);
      }
      $this->xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      $this->xls_dados = new PHPExcel();
      $this->xls_dados->setActiveSheetIndex(0);
      $this->Res       = new grid_datos_3_resumo("out");
   ...
   function grava_arquivo()
   {
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['arr_export']['data'];
      $b_display = false;
      $contr_rowspan = array();
      $contr_colspan = array();
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['xls_file']);
      if (is_file($this->xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_3']['xls_file'] = $this->xls_f;
      }
?>
...
<form name="Fdown" method="get" action="grid_datos_3_download.php" target="_blank" style="display: none"> 
