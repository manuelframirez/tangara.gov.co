<?php
   ...
   session_start();
    $Ord_Cmp = new grid_indicadores_1_1_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_indicadores_1_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['dimension_id_dimension'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['dimension_id_dimension'] = "dimension_id_dimension";
       $tab_converte["dimension_id_dimension"]   = "dimension_id_dimension";
   }
   else
   {
       $tab_def_campos['dimension_id_dimension'] = "`dimension`.`id_dimension`";
       $tab_converte["`dimension`.`id_dimension`"]   = "dimension_id_dimension";
   }
   $tab_labels["dimension_id_dimension"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['labels']["dimension_id_dimension"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['labels']["dimension_id_dimension"] : "Id Dimension";
   $tab_ger_campos['dimension_descripcion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['dimension_descripcion'] = "dimension_descripcion";
       $tab_converte["dimension_descripcion"]   = "dimension_descripcion";
   }
   else
   {
       $tab_def_campos['dimension_descripcion'] = "`dimension`.`Descripcion`";
       $tab_converte["`dimension`.`Descripcion`"]   = "dimension_descripcion";
   }
   $tab_labels["dimension_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['labels']["dimension_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['labels']["dimension_descripcion"] : "Descripcion";
   $tab_ger_campos['tematica_id_tematica'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tematica_id_tematica'] = "tematica_id_tematica";
       $tab_converte["tematica_id_tematica"]   = "tematica_id_tematica";
   }
   else
   {
       $tab_def_campos['tematica_id_tematica'] = "`tematica`.`id_tematica`";
       $tab_converte["`tematica`.`id_tematica`"]   = "tematica_id_tematica";
   }
   $tab_labels["tematica_id_tematica"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['labels']["tematica_id_tematica"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['labels']["tematica_id_tematica"] : "Id Tematica";
   $tab_ger_campos['tematica_descripcion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tematica_descripcion'] = "tematica_descripcion";
       $tab_converte["tematica_descripcion"]   = "tematica_descripcion";
   }
   else
   {
       $tab_def_campos['tematica_descripcion'] = "`tematica`.`Descripcion`";
       $tab_converte["`tematica`.`Descripcion`"]   = "tematica_descripcion";
   }
   $tab_labels["tematica_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['labels']["tematica_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['labels']["tematica_descripcion"] : "Descripcion";
   $tab_ger_campos['indicadores_id_indicadores'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['indicadores_id_indicadores'] = "indicadores_id_indicadores";
       $tab_converte["indicadores_id_indicadores"]   = "indicadores_id_indicadores";
   }
   else
   {
       $tab_def_campos['indicadores_id_indicadores'] = "`indicadores`.`id_indicadores`";
       $tab_converte["`indicadores`.`id_indicadores`"]   = "indicadores_id_indicadores";
   }
   $tab_labels["indicadores_id_indicadores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['labels']["indicadores_id_indicadores"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['labels']["indicadores_id_indicadores"] : "Id Indicadores";
   $tab_ger_campos['indicadores_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['indicadores_nombre'] = "indicadores_nombre";
       $tab_converte["indicadores_nombre"]   = "indicadores_nombre";
   }
   else
   {
       $tab_def_campos['indicadores_nombre'] = "`indicadores`.`Nombre`";
       $tab_converte["`indicadores`.`Nombre`"]   = "indicadores_nombre";
   }
   $tab_labels["indicadores_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['labels']["indicadores_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['labels']["indicadores_nombre"] : "Nombre";
   $tab_ger_campos['variables_id_variable'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['variables_id_variable'] = "variables_id_variable";
       $tab_converte["variables_id_variable"]   = "variables_id_variable";
   }
   else
   {
       $tab_def_campos['variables_id_variable'] = "`variables`.`id_variable`";
       $tab_converte["`variables`.`id_variable`"]   = "variables_id_variable";
   }
   $tab_labels["variables_id_variable"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['labels']["variables_id_variable"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['labels']["variables_id_variable"] : "Id Variable";
   $tab_ger_campos['variables_descripcion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['variables_descripcion'] = "variables_descripcion";
       $tab_converte["variables_descripcion"]   = "variables_descripcion";
   }
   else
   {
       $tab_def_campos['variables_descripcion'] = "`variables`.`descripcion`";
       $tab_converte["`variables`.`descripcion`"]   = "variables_descripcion";
   }
   $tab_labels["variables_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['labels']["variables_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['labels']["variables_descripcion"] : "Descripcion";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       $ordem = (substr($campo_sort, 0, 1) == "+") ? "asc" : "desc";
       $campo = substr($campo_sort, 1);
       $_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['ordem_select'][$campo] = $ordem;
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_indicadores_1_1_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_indicadores_1_1']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
...
<?php
   ...
   {
?>
   <?php echo nmButtonOutput($this->arr_buttons, "bapply", "scSubmitOrderCampos('" . $tbar_pos . "', 'cmp')", "scSubmitOrderCampos('" . $tbar_pos . "', 'cmp')", "f_sel_sub", "", "", "", "absmiddle", "", "0px", $path_btn, "", "", "", "", "", "only_text", "text_right", "", "");
?>
<?php
   }
?>
