...
class grid_indicadores_1_1_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_dimension_id_dimension;
   var $array_total_dimension_descripcion;
   var $array_total_tematica_id_tematica;
   var $array_total_tematica_descripcion;
   var $array_total_indicadores_id_indicadores;
   ...
   //---- 
   function grid_indicadores_1_1_resumo($tipo = "")
   {
      ...
      $this->array_total_dimension_id_dimension     = array();
      $this->array_total_dimension_descripcion      = array();
      $this->array_total_tematica_id_tematica       = array();
      $this->array_total_tematica_descripcion       = array();
      $this->array_total_indicadores_id_indicadores = array();
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['contr_total_geral'] == "OK")
      {
          $this->array_total_dimension_id_dimension = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_total']['dimension_id_dimension'];
          $this->array_total_dimension_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_total']['dimension_descripcion'];
          $this->array_total_tematica_id_tematica = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_total']['tematica_id_tematica'];
          $this->array_total_tematica_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_total']['tematica_descripcion'];
          $this->array_total_indicadores_id_indicadores = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_total']['indicadores_id_indicadores'];
          $this->array_total_indicadores_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_total']['indicadores_nombre'];
          $this->array_total_variables_id_variable = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_total']['variables_id_variable'];
          $this->array_total_variables_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_total']['variables_descripcion'];
      }
      else
      {
          $this->array_total_dimension_id_dimension = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_total']['dimension_id_dimension'] = $this->array_total_dimension_id_dimension;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_total']['dimension_descripcion'] = $this->array_total_dimension_descripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_total']['tematica_id_tematica'] = $this->array_total_tematica_id_tematica;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_total']['tematica_descripcion'] = $this->array_total_tematica_descripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_total']['indicadores_id_indicadores'] = $this->array_total_indicadores_id_indicadores;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_total']['indicadores_nombre'] = $this->array_total_indicadores_nombre;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_total']['variables_id_variable'] = $this->array_total_variables_id_variable;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_total']['variables_descripcion'] = $this->array_total_variables_descripcion;
   ...
   function completeMatrix()
   {
       ...
       //-----
       $this->comp_field_nm = array(
           'dimension_id_dimension' => 0,
           'dimension_descripcion' => 1,
           'tematica_id_tematica' => 2,
           'tematica_descripcion' => 3,
           'indicadores_id_indicadores' => 4,
           'indicadores_nombre' => 5,
           'variables_id_variable' => 6,
           'variables_descripcion' => 7,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['summarizing_fields_control'] = array(
               'NM_Count' => array(
       ...
       //-----
       foreach ($this->array_total_dimension_id_dimension as $i_dimension_id_dimension => $d_dimension_id_dimension) {
           if (!in_array($i_dimension_id_dimension, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_dimension_id_dimension[2] ] = $d_dimension_id_dimension[1];
               $this->comp_label[0][ $d_dimension_id_dimension[2] ] = $d_dimension_id_dimension[1];
           }
           foreach ($this->array_total_dimension_descripcion[$i_dimension_id_dimension] as $i_dimension_descripcion => $d_dimension_descripcion) {
               if (!in_array($i_dimension_descripcion, $this->comp_label[1][ $d_dimension_id_dimension[2] ], true)) {
                   $this->comp_index[1][ $d_dimension_descripcion[2] ] = $d_dimension_descripcion[1];
                   $this->comp_label[1][ $d_dimension_id_dimension[2] ][ $d_dimension_descripcion[2] ] = $d_dimension_descripcion[1];
               }
               foreach ($this->array_total_tematica_id_tematica[$i_dimension_id_dimension][$i_dimension_descripcion] as $i_tematica_id_tematica => $d_tematica_id_tematica) {
                   if (!in_array($i_tematica_id_tematica, $this->comp_label[2][ $d_dimension_id_dimension[2] ][ $d_dimension_descripcion[2] ], true)) {
                       $this->comp_index[2][ $d_tematica_id_tematica[2] ] = $d_tematica_id_tematica[1];
                       $this->comp_label[2][ $d_dimension_id_dimension[2] ][ $d_dimension_descripcion[2] ][ $d_tematica_id_tematica[2] ] = $d_tematica_id_tematica[1];
                   }
                   foreach ($this->array_total_tematica_descripcion[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica] as $i_tematica_descripcion => $d_tematica_descripcion) {
                       if (!in_array($i_tematica_descripcion, $this->comp_label[3][ $d_dimension_id_dimension[2] ][ $d_dimension_descripcion[2] ][ $d_tematica_id_tematica[2] ], true)) {
                           $this->comp_index[3][ $d_tematica_descripcion[2] ] = $d_tematica_descripcion[1];
                           $this->comp_label[3][ $d_dimension_id_dimension[2] ][ $d_dimension_descripcion[2] ][ $d_tematica_id_tematica[2] ][ $d_tematica_descripcion[2] ] = $d_tematica_descripcion[1];
                       }
                       foreach ($this->array_total_indicadores_id_indicadores[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion] as $i_indicadores_id_indicadores => $d_indicadores_id_indicadores) {
                           if (!in_array($i_indicadores_id_indicadores, $this->comp_label[4][ $d_dimension_id_dimension[2] ][ $d_dimension_descripcion[2] ][ $d_tematica_id_tematica[2] ][ $d_tematica_descripcion[2] ], true)) {
                               $this->comp_index[4][ $d_indicadores_id_indicadores[2] ] = $d_indicadores_id_indicadores[1];
                               $this->comp_label[4][ $d_dimension_id_dimension[2] ][ $d_dimension_descripcion[2] ][ $d_tematica_id_tematica[2] ][ $d_tematica_descripcion[2] ][ $d_indicadores_id_indicadores[2] ] = $d_indicadores_id_indicadores[1];
                           }
                           foreach ($this->array_total_indicadores_nombre[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion][$i_indicadores_id_indicadores] as $i_indicadores_nombre => $d_indicadores_nombre) {
                               if (!in_array($i_indicadores_nombre, $this->comp_label[5][ $d_dimension_id_dimension[2] ][ $d_dimension_descripcion[2] ][ $d_tematica_id_tematica[2] ][ $d_tematica_descripcion[2] ][ $d_indicadores_id_indicadores[2] ], true)) {
                                   $this->comp_index[5][ $d_indicadores_nombre[2] ] = $d_indicadores_nombre[1];
                                   $this->comp_label[5][ $d_dimension_id_dimension[2] ][ $d_dimension_descripcion[2] ][ $d_tematica_id_tematica[2] ][ $d_tematica_descripcion[2] ][ $d_indicadores_id_indicadores[2] ][ $d_indicadores_nombre[2] ] = $d_indicadores_nombre[1];
                               }
                               foreach ($this->array_total_variables_id_variable[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion][$i_indicadores_id_indicadores][$i_indicadores_nombre] as $i_variables_id_variable => $d_variables_id_variable) {
                                   if (!in_array($i_variables_id_variable, $this->comp_label[6][ $d_dimension_id_dimension[2] ][ $d_dimension_descripcion[2] ][ $d_tematica_id_tematica[2] ][ $d_tematica_descripcion[2] ][ $d_indicadores_id_indicadores[2] ][ $d_indicadores_nombre[2] ], true)) {
                                       $this->comp_index[6][ $d_variables_id_variable[2] ] = $d_variables_id_variable[1];
                                       $this->comp_label[6][ $d_dimension_id_dimension[2] ][ $d_dimension_descripcion[2] ][ $d_tematica_id_tematica[2] ][ $d_tematica_descripcion[2] ][ $d_indicadores_id_indicadores[2] ][ $d_indicadores_nombre[2] ][ $d_variables_id_variable[2] ] = $d_variables_id_variable[1];
                                   }
                                   foreach ($this->array_total_variables_descripcion[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion][$i_indicadores_id_indicadores][$i_indicadores_nombre][$i_variables_id_variable] as $i_variables_descripcion => $d_variables_descripcion) {
                                       if (!in_array($i_variables_descripcion, $this->comp_label[7][ $d_dimension_id_dimension[2] ][ $d_dimension_descripcion[2] ][ $d_tematica_id_tematica[2] ][ $d_tematica_descripcion[2] ][ $d_indicadores_id_indicadores[2] ][ $d_indicadores_nombre[2] ][ $d_variables_id_variable[2] ], true)) {
                                           $this->comp_index[7][ $d_variables_descripcion[2] ] = $d_variables_descripcion[1];
                                           $this->comp_label[7][ $d_dimension_id_dimension[2] ][ $d_dimension_descripcion[2] ][ $d_tematica_id_tematica[2] ][ $d_tematica_descripcion[2] ][ $d_indicadores_id_indicadores[2] ][ $d_indicadores_nombre[2] ][ $d_variables_id_variable[2] ][ $d_variables_descripcion[2] ] = $d_variables_descripcion[1];
                                       }
                                   }
                               }
                           }
       ...
       //-----
       $this->comp_x_axys = array();
       $this->comp_y_axys = array(0, 1, 2, 3, 4, 5, 6, 7);

       //-----
       $this->comp_align = array('', '', '', '', '', '', '', '');

       //-----
       $this->comp_links_gr = array(0, 1, 2, 3, 4, 5, 6, 7);

       //-----
       $this->comp_links_fl = array(
           array('name' => 'dimension.id_dimension', 'prot' => '@aspass@'),
           array('name' => 'dimension.Descripcion', 'prot' => '@aspass@'),
           array('name' => 'tematica.id_tematica', 'prot' => '@aspass@'),
           array('name' => 'tematica.Descripcion', 'prot' => '@aspass@'),
           array('name' => 'indicadores.id_indicadores', 'prot' => '@aspass@'),
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_tabular'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_dimension_id_dimension => $l_dimension_id_dimension) {
           if (isset($this->array_total_dimension_id_dimension[$i_dimension_id_dimension])) {
               $this->comp_group[$i_dimension_id_dimension] = array();
           }
           foreach ($this->comp_label[1][$i_dimension_id_dimension] as $i_dimension_descripcion => $l_dimension_descripcion) {
               if (isset($this->array_total_dimension_descripcion[$i_dimension_id_dimension][$i_dimension_descripcion])) {
                   $this->comp_group[$i_dimension_id_dimension][$i_dimension_descripcion] = array();
               }
               foreach ($this->comp_label[2][$i_dimension_id_dimension][$i_dimension_descripcion] as $i_tematica_id_tematica => $l_tematica_id_tematica) {
                   if (isset($this->array_total_tematica_id_tematica[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica])) {
                       $this->comp_group[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica] = array();
                   }
                   foreach ($this->comp_label[3][$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica] as $i_tematica_descripcion => $l_tematica_descripcion) {
                       if (isset($this->array_total_tematica_descripcion[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion])) {
                           $this->comp_group[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion] = array();
                       }
                       foreach ($this->comp_label[4][$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion] as $i_indicadores_id_indicadores => $l_indicadores_id_indicadores) {
                           if (isset($this->array_total_indicadores_id_indicadores[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion][$i_indicadores_id_indicadores])) {
                               $this->comp_group[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion][$i_indicadores_id_indicadores] = array();
                           }
                           foreach ($this->comp_label[5][$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion][$i_indicadores_id_indicadores] as $i_indicadores_nombre => $l_indicadores_nombre) {
                               if (isset($this->array_total_indicadores_nombre[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion][$i_indicadores_id_indicadores][$i_indicadores_nombre])) {
                                   $this->comp_group[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion][$i_indicadores_id_indicadores][$i_indicadores_nombre] = array();
                               }
                               foreach ($this->comp_label[6][$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion][$i_indicadores_id_indicadores][$i_indicadores_nombre] as $i_variables_id_variable => $l_variables_id_variable) {
                                   if (isset($this->array_total_variables_id_variable[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion][$i_indicadores_id_indicadores][$i_indicadores_nombre][$i_variables_id_variable])) {
                                       $this->comp_group[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion][$i_indicadores_id_indicadores][$i_indicadores_nombre][$i_variables_id_variable] = array();
                                   }
                                   foreach ($this->comp_label[7][$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion][$i_indicadores_id_indicadores][$i_indicadores_nombre][$i_variables_id_variable] as $i_variables_descripcion => $l_variables_descripcion) {
                                       if (isset($this->array_total_variables_descripcion[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion][$i_indicadores_id_indicadores][$i_indicadores_nombre][$i_variables_id_variable][$i_variables_descripcion])) {
                                           $this->comp_group[$i_dimension_id_dimension][$i_dimension_descripcion][$i_tematica_id_tematica][$i_tematica_descripcion][$i_indicadores_id_indicadores][$i_indicadores_nombre][$i_variables_id_variable][$i_variables_descripcion] = array();
                                       }
                                   }
                               }
                           }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_dimension_id_dimension;
       }
       elseif (1 == $level) {
           $return = $this->array_total_dimension_descripcion;
       }
       elseif (2 == $level) {
           $return = $this->array_total_tematica_id_tematica;
       }
       elseif (3 == $level) {
           $return = $this->array_total_tematica_descripcion;
       }
       elseif (4 == $level) {
           $return = $this->array_total_indicadores_id_indicadores;
       }
       elseif (5 == $level) {
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Id Dimension"),
           ...
           '1|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Descripcion"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           '2|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Id Tematica"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           '3|0' => array(
           ...
           '4|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Id Indicadores"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           '5|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Nombre"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           '6|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Id Variable"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           '7|0' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['pivot_charts'] = $this->comp_chart_data;
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_grid_indicadores_1_1_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_grid_indicadores_1_1_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function resumo_init()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_indicadores_1_1_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['opcao'] = "print";
      ...
      $this->total   = new grid_indicadores_1_1_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_agrupar("res", $this->array_total_dimension_id_dimension, $this->array_total_dimension_descripcion, $this->array_total_tematica_id_tematica, $this->array_total_tematica_descripcion, $this->array_total_indicadores_id_indicadores, $this->array_total_indicadores_nombre, $this->array_total_variables_id_variable, $this->array_total_variables_descripcion);
      ksort($this->array_total_dimension_id_dimension);
      ksort($this->array_total_dimension_descripcion);
      ksort($this->array_total_tematica_id_tematica);
      ksort($this->array_total_tematica_descripcion);
      ksort($this->array_total_indicadores_id_indicadores);
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_indicadores_1_1_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_indicadores_1_1_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_indicadores_1_1_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_indicadores_1_1/grid_indicadores_1_1_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=XX&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&language=es&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_indicadores_1_1/grid_indicadores_1_1_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_indicadores_1_1/grid_indicadores_1_1_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
      ...
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_indicadores_1_1_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
       ...
       $nm_saida->saida("  tb_show('', 'grid_indicadores_1_1_config_pivot.php?nome_apl=grid_indicadores_1_1&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida(" }\r\n");
      ...
      $nm_saida->saida("  {\r\n");
   $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "grid_indicadores_1_1/grid_indicadores_1_1_iframe.php?nmgp_opcao=pdf_res&scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_indicadores_1_1_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['num_css'] . '.css', 'a');
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_indicadores_1_1']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
   ...
   function monta_cabecalho()
   {
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $dimension_id_dimension = $Busca_temp['dimension_id_dimension']; 
          $tmp_pos = strpos($dimension_id_dimension, "##@@");
          if ($tmp_pos !== false)
          {
              $dimension_id_dimension = substr($dimension_id_dimension, 0, $tmp_pos);
          }
          ...
          $tematica_id_tematica = $Busca_temp['tematica_id_tematica']; 
          $tmp_pos = strpos($tematica_id_tematica, "##@@");
          if ($tmp_pos !== false)
          {
              $tematica_id_tematica = substr($tematica_id_tematica, 0, $tmp_pos);
          }
   ...
   //---- 
   function adiciona_registro($quebra_dimension_id_dimension, $quebra_dimension_descripcion, $quebra_tematica_id_tematica, $quebra_tematica_descripcion, $quebra_indicadores_id_indicadores, $quebra_indicadores_nombre, $quebra_variables_id_variable, $quebra_variables_descripcion, $quebra_dimension_id_dimension_orig, $quebra_dimension_descripcion_orig, $quebra_tematica_id_tematica_orig, $quebra_tematica_descripcion_orig, $quebra_indicadores_id_indicadores_orig, $quebra_indicadores_nombre_orig, $quebra_variables_id_variable_orig, $quebra_variables_descripcion_orig)
   {
      //----- Id Dimension
      if (!isset($this->array_total_dimension_id_dimension[$quebra_dimension_id_dimension_orig]))
      {
         $this->array_total_dimension_id_dimension[$quebra_dimension_id_dimension_orig][0] = 1;
         $this->array_total_dimension_id_dimension[$quebra_dimension_id_dimension_orig][1] = $quebra_dimension_id_dimension;
         $this->array_total_dimension_id_dimension[$quebra_dimension_id_dimension_orig][2] = $quebra_dimension_id_dimension_orig;
      }
      else
      {
         $this->array_total_dimension_id_dimension[$quebra_dimension_id_dimension_orig][0]++;
      }
      //----- Descripcion
      if (!isset($this->array_total_dimension_descripcion[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig]))
      {
         $this->array_total_dimension_descripcion[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][0] = 1;
         $this->array_total_dimension_descripcion[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][1] = $quebra_dimension_descripcion;
         $this->array_total_dimension_descripcion[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][2] = $quebra_dimension_descripcion_orig;
      }
      else
      {
         $this->array_total_dimension_descripcion[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][0]++;
      }
      //----- Id Tematica
      if (!isset($this->array_total_tematica_id_tematica[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig]))
      {
         $this->array_total_tematica_id_tematica[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][0] = 1;
         $this->array_total_tematica_id_tematica[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][1] = $quebra_tematica_id_tematica;
         $this->array_total_tematica_id_tematica[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][2] = $quebra_tematica_id_tematica_orig;
      }
      else
      {
         $this->array_total_tematica_id_tematica[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][0]++;
      }
      //----- Descripcion
      if (!isset($this->array_total_tematica_descripcion[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig]))
      {
         $this->array_total_tematica_descripcion[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][0] = 1;
         $this->array_total_tematica_descripcion[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][1] = $quebra_tematica_descripcion;
         $this->array_total_tematica_descripcion[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][2] = $quebra_tematica_descripcion_orig;
      }
      else
      {
         $this->array_total_tematica_descripcion[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][0]++;
      }
      //----- Id Indicadores
      if (!isset($this->array_total_indicadores_id_indicadores[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig]))
      {
         $this->array_total_indicadores_id_indicadores[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][0] = 1;
         $this->array_total_indicadores_id_indicadores[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][1] = $quebra_indicadores_id_indicadores;
         $this->array_total_indicadores_id_indicadores[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][2] = $quebra_indicadores_id_indicadores_orig;
      }
      else
      {
         $this->array_total_indicadores_id_indicadores[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][0]++;
      }
      //----- Nombre
      if (!isset($this->array_total_indicadores_nombre[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][$quebra_indicadores_nombre_orig]))
      {
         $this->array_total_indicadores_nombre[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][$quebra_indicadores_nombre_orig][0] = 1;
         $this->array_total_indicadores_nombre[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][$quebra_indicadores_nombre_orig][1] = $quebra_indicadores_nombre;
         $this->array_total_indicadores_nombre[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][$quebra_indicadores_nombre_orig][2] = $quebra_indicadores_nombre_orig;
      }
      else
      {
         $this->array_total_indicadores_nombre[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][$quebra_indicadores_nombre_orig][0]++;
      }
      //----- Id Variable
      if (!isset($this->array_total_variables_id_variable[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][$quebra_indicadores_nombre_orig][$quebra_variables_id_variable_orig]))
      {
         $this->array_total_variables_id_variable[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][$quebra_indicadores_nombre_orig][$quebra_variables_id_variable_orig][0] = 1;
         $this->array_total_variables_id_variable[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][$quebra_indicadores_nombre_orig][$quebra_variables_id_variable_orig][1] = $quebra_variables_id_variable;
         $this->array_total_variables_id_variable[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][$quebra_indicadores_nombre_orig][$quebra_variables_id_variable_orig][2] = $quebra_variables_id_variable_orig;
      }
      else
      {
         $this->array_total_variables_id_variable[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][$quebra_indicadores_nombre_orig][$quebra_variables_id_variable_orig][0]++;
      }
      //----- Descripcion
      if (!isset($this->array_total_variables_descripcion[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][$quebra_indicadores_nombre_orig][$quebra_variables_id_variable_orig][$quebra_variables_descripcion_orig]))
      {
         $this->array_total_variables_descripcion[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][$quebra_indicadores_nombre_orig][$quebra_variables_id_variable_orig][$quebra_variables_descripcion_orig][0] = 1;
         $this->array_total_variables_descripcion[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][$quebra_indicadores_nombre_orig][$quebra_variables_id_variable_orig][$quebra_variables_descripcion_orig][1] = $quebra_variables_descripcion;
         $this->array_total_variables_descripcion[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][$quebra_indicadores_nombre_orig][$quebra_variables_id_variable_orig][$quebra_variables_descripcion_orig][2] = $quebra_variables_descripcion_orig;
      }
      else
      {
         $this->array_total_variables_descripcion[$quebra_dimension_id_dimension_orig][$quebra_dimension_descripcion_orig][$quebra_tematica_id_tematica_orig][$quebra_tematica_descripcion_orig][$quebra_indicadores_id_indicadores_orig][$quebra_indicadores_nombre_orig][$quebra_variables_id_variable_orig][$quebra_variables_descripcion_orig][0]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->dimension_id_dimension = $rs_res->fields[0] ;  
            $this->dimension_descripcion = $rs_res->fields[1] ;  
            $this->tematica_id_tematica = $rs_res->fields[2] ;  
            $this->tematica_descripcion = $rs_res->fields[3] ;  
            $this->indicadores_id_indicadores = $rs_res->fields[4] ;  
            $this->indicadores_nombre = $rs_res->fields[5] ;  
            $this->variables_id_variable = $rs_res->fields[6] ;  
            $this->variables_descripcion = $rs_res->fields[7] ;  
            $this->dimension_id_dimension_orig = $this->dimension_id_dimension;
            $this->dimension_descripcion_orig = $this->dimension_descripcion;
            $this->tematica_id_tematica_orig = $this->tematica_id_tematica;
            $this->tematica_descripcion_orig = $this->tematica_descripcion;
            $this->indicadores_id_indicadores_orig = $this->indicadores_id_indicadores;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->dimension_id_dimension, $this->dimension_descripcion, $this->tematica_id_tematica, $this->tematica_descripcion, $this->indicadores_id_indicadores, $this->indicadores_nombre, $this->variables_id_variable, $this->variables_descripcion, $this->dimension_id_dimension_orig,  $this->dimension_descripcion_orig,  $this->tematica_id_tematica_orig,  $this->tematica_descripcion_orig,  $this->indicadores_id_indicadores_orig,  $this->indicadores_nombre_orig,  $this->variables_id_variable_orig,  $this->variables_descripcion_orig);
            }
   }
//
