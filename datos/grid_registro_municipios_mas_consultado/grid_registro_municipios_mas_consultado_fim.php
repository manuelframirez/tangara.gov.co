...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["tangara_____grid_registro_municipios_mas_consultado"]))
   {
      unset($_SESSION['session_sec_aplicacao']["tangara_____grid_registro_municipios_mas_consultado"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_registro_municipios_mas_consultado']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_registro_municipios_mas_consultado']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_registro_municipios_mas_consultado']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_registro_municipios_mas_consultado']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_registro_municipios_mas_consultado']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_registro_municipios_mas_consultado</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_registro_municipios_mas_consultado']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_registro_municipios_mas_consultado']['embutida_filho'] as $ind => $sc_init)
          {
