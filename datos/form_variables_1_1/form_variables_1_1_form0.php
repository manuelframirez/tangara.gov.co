<?php
class form_variables_1_1_form extends form_variables_1_1_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['sc_redir_atualiz'] == 'ok')
{
?>
...
<?php
include_once("form_variables_1_1_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_variables_1_1_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['recarga'];
}
...
<?php
 include_once("form_variables_1_1_js0.php");
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['form_variables_1_1'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_variables_1_1'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['fast_search'][2] : "";
?> 
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bnovo", "do_ajax_form_variables_1_1_add_new_line(); return false;", "do_ajax_form_variables_1_1_add_new_line(); return false;", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "");?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_variables_1_1);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_variables_1_1 = $this->form_vert_form_variables_1_1;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_variables_1_1))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_variables_1_1 as $sc_seq_vert => $sc_lixo)
   {
       $this->id_indicador_ = $this->form_vert_form_variables_1_1[$sc_seq_vert]['id_indicador_'];
       $this->id_padre_ = $this->form_vert_form_variables_1_1[$sc_seq_vert]['id_padre_'];
       $this->final_ = $this->form_vert_form_variables_1_1[$sc_seq_vert]['final_'];
       $this->nivel_ = $this->form_vert_form_variables_1_1[$sc_seq_vert]['nivel_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->descripcion_ = $this->form_vert_form_variables_1_1[$sc_seq_vert]['descripcion_']; 
       ...
       $this->id_variable_ = $this->form_vert_form_variables_1_1[$sc_seq_vert]['id_variable_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_variables_1_1_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_variables_1_1_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_variables_1_1_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_variables_1_1_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_variables_1_1_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_variables_1_1_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_variables_1_1 = $guarda_form_vert_form_variables_1_1;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['total'] + 1)?>);</script><?php } ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1_1']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
...
?>
<script>
 parent.scAjaxDetailStatus("form_variables_1_1");
 parent.scAjaxDetailHeight("form_variables_1_1", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
