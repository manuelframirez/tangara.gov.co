...
class grid_registro_municipios_mas_consultado_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_municipio_nombremunicipio;
   ...
   //---- 
   function grid_registro_municipios_mas_consultado_resumo($tipo = "")
   {
      ...
      $this->array_total_municipio_nombremunicipio = array();
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['contr_total_geral'] == "OK")
      {
          $this->array_total_cantidad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['arr_total']['cantidad'];
          $this->array_total_municipio_nombremunicipio = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['arr_total']['municipio_nombremunicipio'];
      }
      else
      {
          $this->array_total_cantidad = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['arr_total']['cantidad'] = $this->array_total_cantidad;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['arr_total']['municipio_nombremunicipio'] = $this->array_total_municipio_nombremunicipio;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $prep_field = array();
       $prep_field['cantidad'] = "Consultas";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['labels'][''] = "Consultas"; 
       $prep_field['municipio_nombremunicipio'] = "Municipio";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['labels'][''] = "Municipio"; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['summarizing_fields_control'] = array(
               'NM_Count' => array(
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['municipio.nombreMunicipio']['alin'] = "''";
       $Arr_parms['municipio.nombreMunicipio']['link'] = "S";
       $Arr_parms['cantidad']['fill'] = "false";
       $Arr_parms['cantidad']['order'] = "label";
       $Arr_parms['municipio_nombremunicipio']['fill'] = "false";
       $Arr_parms['municipio_nombremunicipio']['order'] = "label";
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       $prep_links_fl['municipio.nombreMunicipio'] = array(0 => 'municipio.nombreMunicipio', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_tabular'];
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Consultas"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           ),
           'municipio.nombreMunicipio' => array(
           '0' => array(
               'title'    => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Municipio"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           ),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_charts'] = $this->comp_chart_data;
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_grid_registro_municipios_mas_consultado_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_grid_registro_municipios_mas_consultado_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['embutida'])
                   {
   ...
   function resumo_init()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function inicializa_vars()
   {
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['opcao'] = "print";
      ...
      $this->total   = new grid_registro_municipios_mas_consultado_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_sc_free_group_by("res", $this->array_total_cantidad, $this->array_total_municipio_nombremunicipio);
      ksort($this->array_total_cantidad);
      ksort($this->array_total_municipio_nombremunicipio);
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['doc_word'])
{
      ...
      $sFusionChartModule = grid_registro_municipios_mas_consultado_grafico::getChartModule();
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_registro_municipios_mas_consultado_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_registro_municipios_mas_consultado_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_registro_municipios_mas_consultado_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
   ...
   function monta_barra_top()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_registro_municipios_mas_consultado/grid_registro_municipios_mas_consultado_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_registro_municipios_mas_consultado/grid_registro_municipios_mas_consultado_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_registro_municipios_mas_consultado/grid_registro_municipios_mas_consultado_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_registro_municipios_mas_consultado/grid_registro_municipios_mas_consultado_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_registro_municipios_mas_consultado_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
       ...
       $nm_saida->saida("  tb_show('', 'grid_registro_municipios_mas_consultado_config_pivot.php?nome_apl=grid_registro_municipios_mas_consultado&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida(" }\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grid_registro_municipios_mas_consultado/grid_registro_municipios_mas_consultado_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  {\r\n");
      $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "grid_registro_municipios_mas_consultado/grid_registro_municipios_mas_consultado_iframe.php?scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_registro_municipios_mas_consultado_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['num_css'] . '.css', 'a');
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_bot()
 {
   global $nm_saida;
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['graf_first'] = true;
       ...
       $nm_saida->saida("<TR>\r\n");
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['pivot_charts'] as $chart_index => $chart_data)
       {
           $qtd_col++;
           if ($qtd_col > $lim_col)
           {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
       }
   }
 }
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $municipio_nombremunicipio = $Busca_temp['municipio_nombremunicipio']; 
          $tmp_pos = strpos($municipio_nombremunicipio, "##@@");
          if ($tmp_pos !== false)
          {
              $municipio_nombremunicipio = substr($municipio_nombremunicipio, 0, $tmp_pos);
          }
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($quebra_cantidad, $quebra_municipio_nombremunicipio, $quebra_cantidad_orig, $quebra_municipio_nombremunicipio_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $temp = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_municipios_mas_consultado']['SC_Gb_Free_sql'] as $cmp_gb => $ord)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->registro_fk_municipio = $rs_res->fields[0] ;  
            $this->municipio_nombremunicipio = $rs_res->fields[1] ;  
            $this->cantidad = $rs_res->fields[2] ;  
            $this->cantidad_orig = $this->cantidad;
            $this->municipio_nombremunicipio_orig = $this->municipio_nombremunicipio;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->municipio_nombremunicipio, $this->cantidad_orig,  $this->municipio_nombremunicipio_orig);
            }
   }
//
