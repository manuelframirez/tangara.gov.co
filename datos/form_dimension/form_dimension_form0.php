<?php
class form_dimension_form extends form_dimension_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - dimension"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - dimension"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['sc_redir_atualiz'] == 'ok')
{
?>
...
<?php
include_once("form_dimension_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_dimension_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['recarga'];
}
...
<?php
 include_once("form_dimension_js0.php");
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['form_dimension'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_dimension'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bnovo", "do_ajax_form_dimension_add_new_line(); return false;", "do_ajax_form_dimension_add_new_line(); return false;", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['empty_filter'] = true;
       }
       echo "<tr><td>";
  }
?>
...
<?php
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['descripcion_']) && $this->nmgp_cmp_hidden['descripcion_'] == 'off') { $sStyleHidden_descripcion_ = 'display: none'; }
    ...
    <TD class="scFormLabelOddMult" id="hidden_field_label_descripcion_" style=";<?php echo $sStyleHidden_descripcion_; ?>" > <?php echo $this->nm_new_label['descripcion_'] ?> </TD>
   <?php } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_dimension);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_dimension = $this->form_vert_form_dimension;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_dimension))
   {
       $sc_seq_vert = 0;
   }
   foreach ($this->form_vert_form_dimension as $sc_seq_vert => $sc_lixo)
   {
       $this->id_dimension_ = $this->form_vert_form_dimension[$sc_seq_vert]['id_dimension_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->descripcion_ = $this->form_vert_form_dimension[$sc_seq_vert]['descripcion_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_dimension_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_dimension_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_dimension_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_dimension_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_dimension_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_dimension_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<span id="id_read_on_descripcion_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-descripcion_<?php echo $sc_seq_vert ?>" style=";<?php echo $sStyleReadLab_descripcion_; ?>"><?php echo NM_encode_input($this->descripcion_); ?></span><span id="id_read_off_descripcion_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_descripcion_; ?>">
 ...
 size=50 maxlength=200 alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_dimension = $guarda_form_vert_form_dimension;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['total'] + 1)?>);</script><?php } ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dimension']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
...
?>
<script>
 parent.scAjaxDetailStatus("form_dimension");
 parent.scAjaxDetailHeight("form_dimension", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
