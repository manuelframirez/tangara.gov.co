...
function NM_critica (form, campo, label, mask, tipo, intr, dec, min, max)
{
 ...
 NM_tab_crit[1] = new NM_critica('F1', 'user', 'Usuario', 'naomask', 'lista', 'cxab', 20, 'TUDO');
 NM_tab_crit[2] = new NM_critica('F1', 'pass', 'Contraseña', 'naomask', 'lista', 'cxab', 20, 'TUDO');
 NM_tab_crit[3] = new NM_critica('NM_final');
 NM_tab_crit_1 = new NM_critica(3);
 NM_tab_crit_1[1] = new NM_critica('F1', 'user', 'Usuario', 'naomask', 'lista', 'cxab', 20, 'TUDO');
 NM_tab_crit_1[2] = new NM_critica('F1', 'pass', 'Contraseña', 'naomask', 'lista', 'cxab', 20, 'TUDO');
