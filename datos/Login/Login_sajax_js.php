...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate user
  function do_ajax_Login_validate_user()
  {
    var nomeCampo_user = "user";
    var var_user = scAjaxGetFieldText(nomeCampo_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Login_validate_user(var_user, var_script_case_init, do_ajax_Login_validate_user_cb);
  } // do_ajax_Login_validate_user

  function do_ajax_Login_validate_user_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Login_validate_user_cb

  // ---------- Validate pass
  function do_ajax_Login_validate_pass()
  {
    var nomeCampo_pass = "pass";
    var var_pass = scAjaxGetFieldText(nomeCampo_pass);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Login_validate_pass(var_pass, var_script_case_init, do_ajax_Login_validate_pass_cb);
  } // do_ajax_Login_validate_pass

  function do_ajax_Login_validate_pass_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pass";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Login_validate_pass_cb
  // ---------- Form
  function do_ajax_Login_submit_form()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_Login_submit_form(var_user, var_pass, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_Login_submit_form_cb);
...
?>
  ...
  ajax_field_list[1] = "pass";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "user": {"label": "Usuario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pass": {"label": "Contraseña", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
