...
class grid_datos_1_total
{
   ...
   //----- 
   function grid_datos_1_total($sc_page)
   {
      $this->sc_page = $sc_page;
      $this->nm_data = new nm_data("es");
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_datos_1']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_datos_1']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_1']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_1']['tot_geral'] = array() ;  
      $nm_comando = "select count(*), avg(`datos`.`Valor`) as avg_datos_valor from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_1']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_1']['tot_geral'][0] = ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_1']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_1']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_1']['contr_total_geral'] = "OK";
   } 
   ...
   function quebra_variables_descripcion_descripcion($categoria_nombre, $variables_descripcion, $arg_sum_categoria_nombre, $arg_sum_variables_descripcion) 
   {
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_1']['where_pesq'])) 
      { 
         $nm_comando .= " where `categoria`.`Nombre`" . $arg_sum_categoria_nombre . " and `variables`.`descripcion`" . $arg_sum_variables_descripcion ; 
      } 
      else 
      { 
         $nm_comando .= " and `categoria`.`Nombre`" . $arg_sum_categoria_nombre . " and `variables`.`descripcion`" . $arg_sum_variables_descripcion ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
   ...
   //----- 
   function resumo_descripcion($destino_resumo, &$array_total_categoria_nombre, &$array_total_variables_descripcion)
   {
      global $nada, $nm_lang;
...
$_SESSION['scriptcase']['grid_datos_1']['contr_erro'] = 'off'; 
     ...
     $comando  = "select count(*), avg(`datos`.`Valor`) as avg_datos_valor, `categoria`.`Nombre`, `variables`.`descripcion` from " . $this->Ini->nm_tabela . " " . $this->sc_where_atual . " group by `categoria`.`Nombre`, `variables`.`descripcion`  " . $nmgp_order_by;
      ...
      foreach ($array_db_total as $registro)
      {
         ...
         $variables_descripcion      = $registro[3];
         $variables_descripcion_orig = $registro[3];
         $conteudo = $registro[3];
         ...
         if (isset($categoria_nombre_orig))
         {
            ...
            {
               //-----  variables_descripcion
               if (!isset($array_total_variables_descripcion[$categoria_nombre_orig][$variables_descripcion_orig]))
               {
                  $array_total_variables_descripcion[$categoria_nombre_orig][$variables_descripcion_orig][0] = $registro[0];
                  $array_total_variables_descripcion[$categoria_nombre_orig][$variables_descripcion_orig][1] = $registro[1];
                  $array_total_variables_descripcion[$categoria_nombre_orig][$variables_descripcion_orig][2] = $val_grafico_variables_descripcion;
                  $array_total_variables_descripcion[$categoria_nombre_orig][$variables_descripcion_orig][3] = $variables_descripcion_orig;
               }
               else
               {
                  $array_total_variables_descripcion[$categoria_nombre_orig][$variables_descripcion_orig][0] += $registro[0];
