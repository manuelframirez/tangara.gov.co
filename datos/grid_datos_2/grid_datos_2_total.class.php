...
class grid_datos_2_total
{
   ...
   //----- 
   function grid_datos_2_total($sc_page)
   {
      $this->sc_page = $sc_page;
      $this->nm_data = new nm_data("es");
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_datos_2']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_datos_2']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_2']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_2']['tot_geral'] = array() ;  
      $nm_comando = "select count(*), sum(`datos`.`Valor`) as sum_datos_valor from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_2']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_2']['tot_geral'][0] = ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_2']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_2']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_2']['contr_total_geral'] = "OK";
   } 
   ...
   function quebra_categoria_nombre_descripcion($categoria_nombre, $arg_sum_categoria_nombre) 
   {
      ...
      $nm_comando = "select count(*), sum(`datos`.`Valor`) as sum_datos_valor from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_2']['where_pesq']; 
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_2']['where_pesq'])) 
      { 
   ...
   function quebra_variables1_descripcion_descripcion($categoria_nombre, $variables1_descripcion, $arg_sum_categoria_nombre, $arg_sum_variables1_descripcion) 
   {
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_2']['where_pesq'])) 
      { 
         $nm_comando .= " where `categoria`.`Nombre`" . $arg_sum_categoria_nombre . " and `variables1`.`descripcion`" . $arg_sum_variables1_descripcion ; 
      } 
      else 
      { 
         $nm_comando .= " and `categoria`.`Nombre`" . $arg_sum_categoria_nombre . " and `variables1`.`descripcion`" . $arg_sum_variables1_descripcion ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
   ...
   function quebra_variables_descripcion_descripcion($categoria_nombre, $variables1_descripcion, $variables_descripcion, $arg_sum_categoria_nombre, $arg_sum_variables1_descripcion, $arg_sum_variables_descripcion) 
   {
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_2']['where_pesq'])) 
      { 
         $nm_comando .= " where `categoria`.`Nombre`" . $arg_sum_categoria_nombre . " and `variables1`.`descripcion`" . $arg_sum_variables1_descripcion . " and `variables`.`descripcion`" . $arg_sum_variables_descripcion ; 
      } 
      else 
      { 
         $nm_comando .= " and `categoria`.`Nombre`" . $arg_sum_categoria_nombre . " and `variables1`.`descripcion`" . $arg_sum_variables1_descripcion . " and `variables`.`descripcion`" . $arg_sum_variables_descripcion ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
   ...
   //----- 
   function resumo_descripcion($destino_resumo, &$array_total_categoria_nombre, &$array_total_variables1_descripcion, &$array_total_variables_descripcion)
   {
      global $nada, $nm_lang;
...
$_SESSION['scriptcase']['grid_datos_2']['contr_erro'] = 'off'; 
     ...
     $comando  = "select count(*), sum(`datos`.`Valor`) as sum_datos_valor, `categoria`.`Nombre`, `variables1`.`descripcion`, `variables`.`descripcion` from " . $this->Ini->nm_tabela . " " . $this->sc_where_atual . " group by `categoria`.`Nombre`, `variables1`.`descripcion`, `variables`.`descripcion`  " . $nmgp_order_by;
      ...
      foreach ($array_db_total as $registro)
      {
         ...
         $variables1_descripcion      = $registro[3];
         $variables1_descripcion_orig = $registro[3];
         $conteudo = $registro[3];
         ...
         $variables_descripcion      = $registro[4];
         $variables_descripcion_orig = $registro[4];
         $conteudo = $registro[4];
         ...
         if (isset($categoria_nombre_orig))
         {
            ...
            {
               //-----  variables1_descripcion
               if (!isset($array_total_variables1_descripcion[$categoria_nombre_orig][$variables1_descripcion_orig]))
               {
                  $array_total_variables1_descripcion[$categoria_nombre_orig][$variables1_descripcion_orig][0] = $registro[0];
                  $array_total_variables1_descripcion[$categoria_nombre_orig][$variables1_descripcion_orig][1] = $registro[1];
                  $array_total_variables1_descripcion[$categoria_nombre_orig][$variables1_descripcion_orig][2] = $val_grafico_variables1_descripcion;
                  $array_total_variables1_descripcion[$categoria_nombre_orig][$variables1_descripcion_orig][3] = $variables1_descripcion_orig;
               }
               else
               {
                  $array_total_variables1_descripcion[$categoria_nombre_orig][$variables1_descripcion_orig][0] += $registro[0];
               ...
               {
                  //-----  variables_descripcion
                  if (!isset($array_total_variables_descripcion[$categoria_nombre_orig][$variables1_descripcion_orig][$variables_descripcion_orig]))
                  {
                     $array_total_variables_descripcion[$categoria_nombre_orig][$variables1_descripcion_orig][$variables_descripcion_orig][0] = $registro[0];
                     $array_total_variables_descripcion[$categoria_nombre_orig][$variables1_descripcion_orig][$variables_descripcion_orig][1] = $registro[1];
                     $array_total_variables_descripcion[$categoria_nombre_orig][$variables1_descripcion_orig][$variables_descripcion_orig][2] = $val_grafico_variables_descripcion;
                     $array_total_variables_descripcion[$categoria_nombre_orig][$variables1_descripcion_orig][$variables_descripcion_orig][3] = $variables_descripcion_orig;
                  }
                  else
                  {
                     $array_total_variables_descripcion[$categoria_nombre_orig][$variables1_descripcion_orig][$variables_descripcion_orig][0] += $registro[0];
