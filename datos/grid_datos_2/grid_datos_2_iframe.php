...
$oExportPdf = new grid_datos_2_export_pdf;
$oExportPdf->exportPdf();

class grid_datos_2_export_pdf {
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_datos_2_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_datos_2']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_datos_2']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_datos_2.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_datos_2']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_datos_2']['pdf_name'] : "grid_datos_2.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
