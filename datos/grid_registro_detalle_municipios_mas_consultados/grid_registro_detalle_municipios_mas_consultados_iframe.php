...
$oExportPdf = new grid_registro_detalle_municipios_mas_consultados_export_pdf;
$oExportPdf->exportPdf();

class grid_registro_detalle_municipios_mas_consultados_export_pdf {
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_registro_detalle_municipios_mas_consultados_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_registro_detalle_municipios_mas_consultados']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_registro_detalle_municipios_mas_consultados']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_registro_detalle_municipios_mas_consultados.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_registro_detalle_municipios_mas_consultados']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_registro_detalle_municipios_mas_consultados']['pdf_name'] : "grid_registro_detalle_municipios_mas_consultados.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
