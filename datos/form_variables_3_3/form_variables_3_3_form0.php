<?php
class form_variables_3_3_form extends form_variables_3_3_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_3_3']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_3_3']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_3_3']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_3_3']['sc_redir_atualiz'] == 'ok')
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bnovo", "do_ajax_form_variables_3_3_add_new_line(); return false;", "do_ajax_form_variables_3_3_add_new_line(); return false;", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "");?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_variables_3_3);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_variables_3_3 = $this->form_vert_form_variables_3_3;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_variables_3_3))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_variables_3_3 as $sc_seq_vert => $sc_lixo)
   {
       $this->id_indicador_ = $this->form_vert_form_variables_3_3[$sc_seq_vert]['id_indicador_'];
       $this->id_padre_ = $this->form_vert_form_variables_3_3[$sc_seq_vert]['id_padre_'];
       $this->final_ = $this->form_vert_form_variables_3_3[$sc_seq_vert]['final_'];
       $this->nivel_ = $this->form_vert_form_variables_3_3[$sc_seq_vert]['nivel_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->descripcion_ = $this->form_vert_form_variables_3_3[$sc_seq_vert]['descripcion_']; 
       ...
       $this->id_variable_ = $this->form_vert_form_variables_3_3[$sc_seq_vert]['id_variable_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_variables_3_3_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_variables_3_3_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_variables_3_3_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_variables_3_3_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_variables_3_3_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_variables_3_3_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_variables_3_3 = $guarda_form_vert_form_variables_3_3;
   } 
   if ($Table_refresh) 
   { 
