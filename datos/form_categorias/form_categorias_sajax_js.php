...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate fk_tipo_categoria_
  function do_ajax_form_categorias_validate_fk_tipo_categoria_(iNumLinha)
  {
    var nomeCampo_fk_tipo_categoria_ = "fk_tipo_categoria_" + iNumLinha;
    var var_fk_tipo_categoria_ = scAjaxGetFieldSelect(nomeCampo_fk_tipo_categoria_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_validate_fk_tipo_categoria_(var_fk_tipo_categoria_, iNumLinha, var_script_case_init, do_ajax_form_categorias_validate_fk_tipo_categoria__cb);
  } // do_ajax_form_categorias_validate_fk_tipo_categoria_

  function do_ajax_form_categorias_validate_fk_tipo_categoria__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fk_tipo_categoria_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fk_tipo_categoria_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "fk_tipo_categoria_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fk_tipo_categoria_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_validate_fk_tipo_categoria__cb

  // ---------- Validate nombre_
  function do_ajax_form_categorias_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_categorias_validate_nombre__cb);
  } // do_ajax_form_categorias_validate_nombre_

  function do_ajax_form_categorias_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_validate_nombre__cb

  // ---------- Validate id_categoria_
  function do_ajax_form_categorias_validate_id_categoria_(iNumLinha)
  {
    var nomeCampo_id_categoria_ = "id_categoria_" + iNumLinha;
    var var_id_categoria_ = scAjaxGetFieldHidden(nomeCampo_id_categoria_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_validate_id_categoria_(var_id_categoria_, iNumLinha, var_script_case_init, do_ajax_form_categorias_validate_id_categoria__cb);
  } // do_ajax_form_categorias_validate_id_categoria_

  function do_ajax_form_categorias_validate_id_categoria__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_validate_id_categoria__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_categorias_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_categorias_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_categorias_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_categorias_add_new_line_cb);
  } // do_ajax_form_categorias_add_new_line

  function do_ajax_form_categorias_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_categorias_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_categorias_backup_line(iNumLinha)
  {
    var var_id_categoria_ = scAjaxGetFieldHidden("id_categoria_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_backup_line(var_id_categoria_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_categorias_backup_line_cb);
  } // do_ajax_form_categorias_backup_line

  function do_ajax_form_categorias_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_categorias_backup_line_cb

  function do_ajax_form_categorias_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_categorias_cancel_insert

  function do_ajax_form_categorias_cancel_update(iSeqVert)
  {
    do_ajax_form_categorias_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_categorias_cancel_update

  function do_ajax_form_categorias_restore_buttons()
  {
<?php
...
?>
  ...
  // ---------- table_refresh
  function do_ajax_form_categorias_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_categorias_table_refresh(var_id_categoria_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_categorias_table_refresh_cb);
  } //  do_ajax_form_categorias_table_refresh

  function do_ajax_form_categorias_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_categorias_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_categorias_submit_form(iNumLinha, indexTR)
  {
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_fk_tipo_categoria_ = scAjaxGetFieldSelect("fk_tipo_categoria_" + iNumLinha);
...
?>
    x_ajax_form_categorias_submit_form(var_fk_tipo_categoria_, var_nombre_, var_id_categoria_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_categorias_submit_form_cb);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("fk_tipo_categoria_" + sc_num_ult_line);
...
?>
  ...
  function do_ajax_form_categorias_navigate_form()
  {
    ...
    if (sc_insert_open)
    {
        do_ajax_form_categorias_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("fk_tipo_categoria_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_categorias_navigate_form(var_id_categoria_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_script_case_init, do_ajax_form_categorias_navigate_form_cb);
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "fk_tipo_categoria_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_categoria_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["fk_tipo_categoria_" + iNumLinha] = {"label": "Tipo de categoria<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["fk_tipo_categoria_"][iNumLinha] = "fk_tipo_categoria_" + iNumLinha;
    ajax_field_mult["nombre_"][iNumLinha] = "nombre_" + iNumLinha;
    ajax_field_mult["id_categoria_"][iNumLinha] = "id_categoria_" + iNumLinha;
    ajax_field_id["fk_tipo_categoria_" + iNumLinha] = new Array("hidden_field_label_fk_tipo_categoria_", "hidden_field_data_fk_tipo_categoria_" + iNumLinha);
    ajax_field_id["nombre_" + iNumLinha] = new Array("hidden_field_label_nombre_", "hidden_field_data_nombre_" + iNumLinha);
    ajax_error_count["fk_tipo_categoria_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["fk_tipo_categoria_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["fk_tipo_categoria_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["fk_tipo_categoria_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["fk_tipo_categoria_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fk_tipo_categoria_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fk_tipo_categoria_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fk_tipo_categoria_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fk_tipo_categoria_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fk_tipo_categoria_'])) ? $this->nmgp_cmp_readonly['fk_tipo_categoria_'] : 'off';
?>
    scAjaxFieldRead("fk_tipo_categoria_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("fk_tipo_categoria_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["fk_tipo_categoria_" + iRow] || "on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["id_categoria_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_fk_tipo_categoria_" + iRow))
        document.getElementById("hidden_field_data_fk_tipo_categoria_" + iRow).className = "scFormErrorLine";
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["fk_tipo_categoria_" + iRow] && "off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["id_categoria_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["fk_tipo_categoria_" + iRow] = "off";
      ...
      if (document.getElementById("hidden_field_data_fk_tipo_categoria_" + iRow))
        document.getElementById("hidden_field_data_fk_tipo_categoria_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_nombre_" + iRow))
