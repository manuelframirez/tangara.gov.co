  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_categorias_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_categorias_inline_validate_fk_tipo_categoria_()
  {
    var nomeCampo_fk_tipo_categoria_ = "fk_tipo_categoria_";
    var var_fk_tipo_categoria_ = scAjaxGetFieldSelect(nomeCampo_fk_tipo_categoria_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_inline_validate_fk_tipo_categoria_(var_fk_tipo_categoria_, var_script_case_init, do_ajax_form_categorias_inline_validate_fk_tipo_categoria__cb);
  } // do_ajax_form_categorias_inline_validate_fk_tipo_categoria_

  function do_ajax_form_categorias_inline_validate_fk_tipo_categoria__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_inline_validate_fk_tipo_categoria__cb

  // ---------- Validate nombre_
  function do_ajax_form_categorias_inline_validate_nombre_()
  {
    var nomeCampo_nombre_ = "nombre_";
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_inline_validate_nombre_(var_nombre_, var_script_case_init, do_ajax_form_categorias_inline_validate_nombre__cb);
  } // do_ajax_form_categorias_inline_validate_nombre_

  function do_ajax_form_categorias_inline_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre_";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_inline_validate_nombre__cb

  // ---------- Validate id_categoria_
  function do_ajax_form_categorias_inline_validate_id_categoria_()
  {
    var nomeCampo_id_categoria_ = "id_categoria_";
    var var_id_categoria_ = scAjaxGetFieldText(nomeCampo_id_categoria_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_inline_validate_id_categoria_(var_id_categoria_, var_script_case_init, do_ajax_form_categorias_inline_validate_id_categoria__cb);
  } // do_ajax_form_categorias_inline_validate_id_categoria_

  function do_ajax_form_categorias_inline_validate_id_categoria__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_inline_validate_id_categoria__cb
  // ---------- Form
  function do_ajax_form_categorias_inline_submit_form()
  {
    scAjaxHideMessage();
    var var_fk_tipo_categoria_ = scAjaxGetFieldSelect("fk_tipo_categoria_");
    var var_nombre_ = scAjaxGetFieldText("nombre_");
    var var_id_categoria_ = scAjaxGetFieldText("id_categoria_");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_categorias_inline_submit_form(var_fk_tipo_categoria_, var_nombre_, var_id_categoria_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_categorias_inline_submit_form_cb);
  } // do_ajax_form_categorias_inline_submit_form

  function do_ajax_form_categorias_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("fk_tipo_categoria_");
      scAjaxHideErrorDisplay("nombre_");
      scAjaxHideErrorDisplay("id_categoria_");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_categorias_inline_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_categorias_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_categorias_inline_navigate_form(var_id_categoria_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_categorias_inline_navigate_form_cb);
  } // do_ajax_form_categorias_inline_navigate_form

  function do_ajax_form_categorias_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_categorias_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_categorias_inline_navigate_form_cb
  ...
  ajax_field_list[0] = "fk_tipo_categoria_";
  ajax_field_list[1] = "nombre_";
  ajax_field_list[2] = "id_categoria_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "fk_tipo_categoria_": {"label": "Tipo de categoria", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nombre_": {"label": "Nombre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_categoria_": {"label": "Id Categoria", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["fk_tipo_categoria_"][1] = "fk_tipo_categoria_";
  ajax_field_mult["nombre_"][1] = "nombre_";
  ajax_field_mult["id_categoria_"][1] = "id_categoria_";

  var ajax_field_id = {
    "fk_tipo_categoria_": new Array("hidden_field_label_fk_tipo_categoria_", "hidden_field_data_fk_tipo_categoria_"),
    "nombre_": new Array("hidden_field_label_nombre_", "hidden_field_data_nombre_")
  };

  var ajax_read_only = {
    "fk_tipo_categoria_": "off",
    "nombre_": "off",
    "id_categoria_": "on"
  };
