...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_categoria_' + iSeqRow).bind('blur', function() { sc_form_categorias_id_categoria__onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_categorias_id_categoria__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nombre_' + iSeqRow).bind('blur', function() { sc_form_categorias_nombre__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_categorias_nombre__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fk_tipo_categoria_' + iSeqRow).bind('blur', function() { sc_form_categorias_fk_tipo_categoria__onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_categorias_fk_tipo_categoria__onchange(this, iSeqRow) })
...
function sc_form_categorias_id_categoria__onblur(oThis, iSeqRow) {
  do_ajax_form_categorias_validate_id_categoria_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_categorias_id_categoria__onchange(oThis, iSeqRow) {
...
function sc_form_categorias_nombre__onblur(oThis, iSeqRow) {
  do_ajax_form_categorias_validate_nombre_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_categorias_nombre__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
...
function sc_form_categorias_fk_tipo_categoria__onblur(oThis, iSeqRow) {
  do_ajax_form_categorias_validate_fk_tipo_categoria_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_categorias_fk_tipo_categoria__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
