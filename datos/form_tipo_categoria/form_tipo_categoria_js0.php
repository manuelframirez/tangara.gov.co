<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type=hidden name="id_tipo_categoria_" value="<?php echo NM_encode_input($this->nmgp_dados_form['id_tipo_categoria_']); ?>">
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_tipo_categoria_submit_form(y, z); 
} 
<?php
}
?>
