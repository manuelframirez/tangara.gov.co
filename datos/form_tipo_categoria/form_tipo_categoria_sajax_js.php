  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipo_categoria" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate tipo_categoria_
  function do_ajax_form_tipo_categoria_validate_tipo_categoria_(iNumLinha)
  {
    var nomeCampo_tipo_categoria_ = "tipo_categoria_" + iNumLinha;
    var var_tipo_categoria_ = scAjaxGetFieldText(nomeCampo_tipo_categoria_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_categoria_validate_tipo_categoria_(var_tipo_categoria_, iNumLinha, var_script_case_init, do_ajax_form_tipo_categoria_validate_tipo_categoria__cb);
  } // do_ajax_form_tipo_categoria_validate_tipo_categoria_

  function do_ajax_form_tipo_categoria_validate_tipo_categoria__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tipo_categoria_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tipo_categoria_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tipo_categoria_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tipo_categoria_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_categoria_validate_tipo_categoria__cb

  // ---------- Validate id_tipo_categoria_
  function do_ajax_form_tipo_categoria_validate_id_tipo_categoria_(iNumLinha)
  {
    var nomeCampo_id_tipo_categoria_ = "id_tipo_categoria_" + iNumLinha;
    var var_id_tipo_categoria_ = scAjaxGetFieldHidden(nomeCampo_id_tipo_categoria_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_categoria_validate_id_tipo_categoria_(var_id_tipo_categoria_, iNumLinha, var_script_case_init, do_ajax_form_tipo_categoria_validate_id_tipo_categoria__cb);
  } // do_ajax_form_tipo_categoria_validate_id_tipo_categoria_

  function do_ajax_form_tipo_categoria_validate_id_tipo_categoria__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_tipo_categoria_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_tipo_categoria_";
    }
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_tipo_categoria_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_tipo_categoria_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_categoria_validate_id_tipo_categoria__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tipo_categoria_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tipo_categoria_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tipo_categoria_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tipo_categoria_add_new_line_cb);
  } // do_ajax_form_tipo_categoria_add_new_line

  function do_ajax_form_tipo_categoria_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_tipo_categoria_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tipo_categoria_backup_line(iNumLinha)
  {
    var var_id_tipo_categoria_ = scAjaxGetFieldHidden("id_tipo_categoria_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_categoria_backup_line(var_id_tipo_categoria_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tipo_categoria_backup_line_cb);
  } // do_ajax_form_tipo_categoria_backup_line

  function do_ajax_form_tipo_categoria_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_tipo_categoria_backup_line_cb

  function do_ajax_form_tipo_categoria_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tipo_categoria_cancel_insert

  function do_ajax_form_tipo_categoria_cancel_update(iSeqVert)
  {
    do_ajax_form_tipo_categoria_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tipo_categoria_cancel_update

  function do_ajax_form_tipo_categoria_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tipo_categoria_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tipo_categoria_table_refresh()
  {
    var var_id_tipo_categoria_ = document.F2.id_tipo_categoria_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_categoria_table_refresh(var_id_tipo_categoria_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_tipo_categoria_table_refresh_cb);
  } //  do_ajax_form_tipo_categoria_table_refresh

  function do_ajax_form_tipo_categoria_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.id_tipo_categoria_.value = scAjaxGetKeyValue("id_tipo_categoria_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_tipo_categoria_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tipo_categoria_submit_form(iNumLinha, indexTR)
  {
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_tipo_categoria_ = scAjaxGetFieldText("tipo_categoria_" + iNumLinha);
    var var_id_tipo_categoria_ = scAjaxGetFieldHidden("id_tipo_categoria_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tipo_categoria_submit_form(var_tipo_categoria_, var_id_tipo_categoria_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_tipo_categoria_submit_form_cb);
  } // do_ajax_form_tipo_categoria_submit_form

  function do_ajax_form_tipo_categoria_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tipo_categoria_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("id_tipo_categoria_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_tipo_categoria_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tipo_categoria_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tipo_categoria_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tipo_categoria_" + iNavForm);
      scAjaxHideErrorDisplay("id_tipo_categoria_" + iNavForm);
    }
    var var_id_tipo_categoria_ = document.F2.id_tipo_categoria_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tipo_categoria_navigate_form(var_id_tipo_categoria_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_script_case_init, do_ajax_form_tipo_categoria_navigate_form_cb);
  } // do_ajax_form_tipo_categoria_navigate_form

  function do_ajax_form_tipo_categoria_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_tipo_categoria_.value = scAjaxGetKeyValue("id_tipo_categoria_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_tipo_categoria_navigate_form_cb
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tipo_categoria_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_tipo_categoria_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tipo_categoria_" + iNumLinha] = {"label": "Tipo Categoria<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["id_tipo_categoria_" + iNumLinha] = {"label": "Id Tipo Categoria<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["tipo_categoria_"][iNumLinha] = "tipo_categoria_" + iNumLinha;
    ajax_field_mult["id_tipo_categoria_"][iNumLinha] = "id_tipo_categoria_" + iNumLinha;
    ajax_field_id["tipo_categoria_" + iNumLinha] = new Array("hidden_field_label_tipo_categoria_", "hidden_field_data_tipo_categoria_" + iNumLinha);
    ajax_error_count["tipo_categoria_" + iNumLinha] = "off";
    ajax_error_count["id_tipo_categoria_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tipo_categoria_" + iNumLinha] = "off";
    ajax_read_only["id_tipo_categoria_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["tipo_categoria_" + iNumLinha] = "on";
    ajax_read_only["id_tipo_categoria_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["tipo_categoria_" + iNumLinha] = null;
    ajax_error_list["id_tipo_categoria_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "tipo_categoria_": new Array(),
    "id_tipo_categoria_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tipo_categoria_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tipo_categoria_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tipo_categoria_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tipo_categoria_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tipo_categoria_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["id_tipo_categoria_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_tipo_categoria_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_tipo_categoria_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_tipo_categoria_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_tipo_categoria_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tipo_categoria_'])) ? $this->nmgp_cmp_readonly['tipo_categoria_'] : 'off';
?>
    scAjaxFieldRead("tipo_categoria_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_tipo_categoria_'])) ? $this->nmgp_cmp_readonly['id_tipo_categoria_'] : 'on';
?>
    scAjaxFieldRead("id_tipo_categoria_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("tipo_categoria_" + iSeq, "on");
    scAjaxFieldRead("id_tipo_categoria_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tipo_categoria_" + iRow] || "on" == ajax_error_count["id_tipo_categoria_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_tipo_categoria_" + iRow))
        document.getElementById("hidden_field_data_tipo_categoria_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_id_tipo_categoria_" + iRow))
        document.getElementById("hidden_field_data_id_tipo_categoria_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tipo_categoria_" + iRow] && "off" == ajax_error_count["id_tipo_categoria_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tipo_categoria_" + iRow] = "off";
        ajax_error_count["id_tipo_categoria_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_tipo_categoria_" + iRow))
        document.getElementById("hidden_field_data_tipo_categoria_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_id_tipo_categoria_" + iRow))
        document.getElementById("hidden_field_data_id_tipo_categoria_" + iRow).className = sCssLine;
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("tipo_categoria_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("id_tipo_categoria_" == sIndex)
    {
