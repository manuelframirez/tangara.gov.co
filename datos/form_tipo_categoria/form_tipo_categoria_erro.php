...
$old_error_handler = set_error_handler("form_tipo_categoria_scriptcase_error_handler");

function form_tipo_categoria_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_tipo_categoria']['contr_erro']) && $_SESSION['scriptcase']['form_tipo_categoria']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_tipo_categoria->contr_form_tipo_categoria->Apl_com_erro = true;
            if ($inicial_form_tipo_categoria->contr_form_tipo_categoria->NM_ajax_flag)
            {
                $inicial_form_tipo_categoria->contr_form_tipo_categoria->NM_ajax_info['errList']['geral_form_tipo_categoria'][] = $msg;
                return;
            }
            form_tipo_categoria_scriptcase_error_display($msg, $err_no);
        }
...
function form_tipo_categoria_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tipo_categoria'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tipo_categoria'])  ? $_SESSION['scriptcase']['error_icon']['form_tipo_categoria']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tipo_categoria']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tipo_categoria']) ? $_SESSION['scriptcase']['error_span_title']['form_tipo_categoria'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tipo_categoria']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tipo_categoria']) ? $_SESSION['scriptcase']['error_icon_title']['form_tipo_categoria'] : '';
?>
