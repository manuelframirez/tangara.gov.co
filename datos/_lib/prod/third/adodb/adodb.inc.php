...
*/
	...
	*/
	 ...
	 * @return true or false
	 */	  
	function NConnect($argHostname = "", $argUsername = "", $argPassword = "", $argDatabaseName = "", $arrExtraArgs="", $charset="") 
	{
	 ...
	 */	
	function PConnect($argHostname = "", $argUsername = "", $argPassword = "", $argDatabaseName = "", $arrExtraArgs = "", $charset = "")
	{
	...
	*/
	...
	function sc_finalize_debug($start)
	{
		...
		$total = $end - $start;
		$str_file  = $ident . "Execução: ". $total ." segundos\r\n";
		$str_file .= $ident . "\r\n-------------------------------------------------------------------------\r\n\r\n";
