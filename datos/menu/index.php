...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_dimension") . "/form_dimension_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_dimension']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_dimension'] = "on";
    }
}
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tematica") . "/form_tematica_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tematica']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_tematica'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_indicadores") . "/form_indicadores_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_indicadores']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_indicadores'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_agregar_fuente") . "/form_agregar_fuente_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_agregar_fuente']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_agregar_fuente'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("buscar_fuente") . "/buscar_fuente_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['buscar_fuente']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['buscar_fuente'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[1]))
{
 ...
 $nm_var_lab[2] = "Modificar indicador";
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_dimension']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_dimension']) == "on")
{
    $menu_menuData['data'] .= "item_3|.|" . $nm_var_lab[0] . "|menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=form_dimension&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_3|.|" . $nm_var_lab[0] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tematica']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tematica']) == "on")
{
    $menu_menuData['data'] .= "item_2|.|" . $nm_var_lab[1] . "|menu_form_php.php?sc_item_menu=item_2&sc_apl_menu=form_tematica&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_2|.|" . $nm_var_lab[1] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_indicadores']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_indicadores']) == "on")
{
    $menu_menuData['data'] .= "item_1|.|" . $nm_var_lab[2] . "|menu_form_php.php?sc_item_menu=item_1&sc_apl_menu=form_indicadores&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_1|.|" . $nm_var_lab[2] . "||||_self|disabled\n";
}
$menu_menuData['data'] .= "item_4|.|" . $nm_var_lab[3] . "||" . $nm_var_hint[3] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_agregar_fuente']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_agregar_fuente']) == "on")
{
    $menu_menuData['data'] .= "item_5|..|" . $nm_var_lab[4] . "|menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=form_agregar_fuente&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_5|..|" . $nm_var_lab[4] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['buscar_fuente']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['buscar_fuente']) == "on")
{
    $menu_menuData['data'] .= "item_6|..|" . $nm_var_lab[5] . "|menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=buscar_fuente&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_6|..|" . $nm_var_lab[5] . "||||_self|disabled\n";
}
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_dimension']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_dimension']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[0] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=form_dimension&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[0] . "",
        'id'       => "item_3",
        'icon'     => "",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tematica']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tematica']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[1] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_2&sc_apl_menu=form_tematica&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[1] . "",
        'id'       => "item_2",
        'icon'     => "",
        'target'   => " item-target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_indicadores']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_indicadores']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[2] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_1&sc_apl_menu=form_indicadores&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[2] . "",
        'id'       => "item_1",
        'icon'     => "",
        'target'   => " item-target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_agregar_fuente']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_agregar_fuente']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[4] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=form_agregar_fuente&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[4] . "",
        'id'       => "item_5",
        'icon'     => "",
        'target'   => " item-target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['buscar_fuente']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['buscar_fuente']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[5] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=buscar_fuente&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[5] . "",
        'id'       => "item_6",
        'icon'     => "",
        'target'   => " item-target=\"" . $this->menu_target('_self') . "\"",
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $menu_menuData); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
    <td style="border-width: 1px; height: 100%; padding: 0px">
      <iframe id="iframe_menu" name="menu_iframe" frameborder="0" class="scMenuIframe"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : $menu_menuData['url']['link'] . $this->tab_grupo['0']); ?><?php echo ($NM_scr_iframe != "" ? "" :"" . SC_dir_app_name('form_dimension') . "/?nm_run_menu=1&nm_apl_menu=menu&script_case_init=1&script_case_session=" . session_id() ); ?>" ></iframe>
<?php
}
?>
    </td>
