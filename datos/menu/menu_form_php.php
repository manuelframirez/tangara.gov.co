...
<?php
      ...
      {
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "form_dimension")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_dimension") . "/?nm_run_menu=1&nm_apl_menu=menu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "form_tematica")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_tematica") . "/?nm_run_menu=1&nm_apl_menu=menu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "form_indicadores")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_indicadores") . "/?nm_run_menu=1&nm_apl_menu=menu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "form_agregar_fuente")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_agregar_fuente") . "/?nm_run_menu=1&nm_apl_menu=menu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "buscar_fuente")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("buscar_fuente") . "/?nm_run_menu=1&nm_apl_menu=menu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      }
      if (!$link_url)
      {
