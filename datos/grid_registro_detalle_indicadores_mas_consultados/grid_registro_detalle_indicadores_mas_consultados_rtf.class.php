...
class grid_registro_detalle_indicadores_mas_consultados_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_registro_detalle_indicadores_mas_consultados_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "grid_registro_detalle_indicadores_mas_consultados.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['rtf_name']);
      }
      ...
      { 
          ...
          if ($Cada_col == "municipio_nombremunicipio" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
   ...
   {
         if (!NM_is_utf8($this->municipio_nombremunicipio))
         {
             $this->municipio_nombremunicipio = mb_convert_encoding($this->municipio_nombremunicipio, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
          $this->municipio_nombremunicipio = str_replace('<', '&lt;', $this->municipio_nombremunicipio);
          $this->municipio_nombremunicipio = str_replace('>', '&gt;', $this->municipio_nombremunicipio);
         $this->texto_tag .= "<td>" . $this->municipio_nombremunicipio . "</td>\r\n";
   }
   //----- registro_fecha
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
