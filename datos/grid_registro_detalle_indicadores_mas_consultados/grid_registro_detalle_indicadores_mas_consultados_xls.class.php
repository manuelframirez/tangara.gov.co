...
class grid_registro_detalle_indicadores_mas_consultados_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $tit_doc;
   //---- 
   function grid_registro_detalle_indicadores_mas_consultados_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".xls";
      $this->tit_doc    = "grid_registro_detalle_indicadores_mas_consultados.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['xls_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['xls_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['xls_name']);
          $this->xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
   ...
   function NM_export_municipio_nombremunicipio()
   {
         ...
         $this->xls_dados->getActiveSheet()->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->xls_dados->getActiveSheet()->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->municipio_nombremunicipio);
         $this->xls_col++;
   }
   //----- registro_fecha
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['xls_file']);
      if (is_file($this->xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['xls_file'] = $this->xls_f;
      }
?>
