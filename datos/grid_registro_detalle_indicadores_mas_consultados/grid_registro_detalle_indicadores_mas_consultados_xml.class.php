...
class grid_registro_detalle_indicadores_mas_consultados_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_registro_detalle_indicadores_mas_consultados_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "grid_registro_detalle_indicadores_mas_consultados.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_registro_detalle_indicadores_mas_consultados";
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->municipio_nombremunicipio))
         {
             $this->municipio_nombremunicipio = mb_convert_encoding($this->municipio_nombremunicipio, "UTF-8");
         }
         $this->xml_registro .= " municipio_nombremunicipio =\"" . $this->trata_dados($this->municipio_nombremunicipio) . "\"";
   }
   //----- registro_fecha
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_registro_detalle_indicadores_mas_consultados']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
