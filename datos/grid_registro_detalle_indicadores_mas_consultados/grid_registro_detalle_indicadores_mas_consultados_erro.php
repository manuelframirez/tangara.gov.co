...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['grid_registro_detalle_indicadores_mas_consultados']['contr_erro']) && $_SESSION['scriptcase']['grid_registro_detalle_indicadores_mas_consultados']['contr_erro'] == 'on')
    {
