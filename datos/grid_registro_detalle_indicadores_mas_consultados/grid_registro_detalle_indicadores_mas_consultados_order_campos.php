<?php
   ...
   session_start();
    $Ord_Cmp = new grid_registro_detalle_indicadores_mas_consultados_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_registro_detalle_indicadores_mas_consultados_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['municipio_nombremunicipio'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['municipio_nombremunicipio'] = "municipio_nombremunicipio";
       $tab_converte["municipio_nombremunicipio"]   = "municipio_nombremunicipio";
   }
   else
   {
       $tab_def_campos['municipio_nombremunicipio'] = "`municipio`.`nombreMunicipio`";
       $tab_converte["`municipio`.`nombreMunicipio`"]   = "municipio_nombremunicipio";
   }
   $tab_labels["municipio_nombremunicipio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_registro_detalle_indicadores_mas_consultados']['labels']["municipio_nombremunicipio"])) ? $_SESSION['sc_session'][$sc_init]['grid_registro_detalle_indicadores_mas_consultados']['labels']["municipio_nombremunicipio"] : "Nombre Municipio";
   ...
   $tab_labels["registro_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_registro_detalle_indicadores_mas_consultados']['labels']["registro_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_registro_detalle_indicadores_mas_consultados']['labels']["registro_fecha"] : "Fecha";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_registro_detalle_indicadores_mas_consultados']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_registro_detalle_indicadores_mas_consultados']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_registro_detalle_indicadores_mas_consultados']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_registro_detalle_indicadores_mas_consultados']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_registro_detalle_indicadores_mas_consultados']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_registro_detalle_indicadores_mas_consultados']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_registro_detalle_indicadores_mas_consultados']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_registro_detalle_indicadores_mas_consultados']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       $ordem = (substr($campo_sort, 0, 1) == "+") ? "asc" : "desc";
       $campo = substr($campo_sort, 1);
       $_SESSION['sc_session'][$sc_init]['grid_registro_detalle_indicadores_mas_consultados']['ordem_select'][$campo] = $ordem;
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_registro_detalle_indicadores_mas_consultados_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_registro_detalle_indicadores_mas_consultados']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_registro_detalle_indicadores_mas_consultados']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
