...
else
{
    ...
    $_SESSION['scriptcase']['variables']['glo_nm_path_prod'] = "";
    $_SESSION['scriptcase']['variables']['glo_nm_perfil']    = "";
    $_SESSION['scriptcase']['variables']['glo_nm_usa_grupo'] = "";
...
class variables_class
{
 ...
 function variables_menu()
 {
    global $variables_menuData;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['variables']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
      ...
      //check prod
      if(empty($_SESSION['scriptcase']['variables']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['variables']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
$path_libs      = $str_root . $_SESSION['scriptcase']['variables']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['variables']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['variables']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "variables/img";
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/variables_erro.php");
}
include_once(dirname(__FILE__) . "/variables_erro.class.php"); 
$this->Erro = new variables_erro();
$str_path = substr($_SESSION['scriptcase']['variables']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['variables']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['variables']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$variables_menuData         = array();
$variables_menuData['path'] = array();
$variables_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $variables_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $variables_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $variables_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $variables_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$variables_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$variables_menuData['url']['web']   = str_replace("\\", '/', $variables_menuData['url']['web']);
$variables_menuData['path']['root'] = substr($variables_menuData['path']['sys'],  0, -1 * strlen($variables_menuData['url']['web']));
$variables_menuData['path']['app']  = substr($variables_menuData['path']['sys'],  0, strrpos($variables_menuData['path']['sys'],  '/'));
$variables_menuData['path']['link'] = substr($variables_menuData['path']['app'],  0, strrpos($variables_menuData['path']['app'],  '/'));
$variables_menuData['path']['link'] = substr($variables_menuData['path']['link'], 0, strrpos($variables_menuData['path']['link'], '/')) . '/';
$variables_menuData['path']['app'] .= '/';
$variables_menuData['url']['app']   = substr($variables_menuData['url']['web'],  0, strrpos($variables_menuData['url']['web'],  '/'));
$variables_menuData['url']['link']  = substr($variables_menuData['url']['app'],  0, strrpos($variables_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['variables']['glo_nm_usa_grupo'] == "S")
{
    $variables_menuData['url']['link']  = substr($variables_menuData['url']['link'], 0, strrpos($variables_menuData['url']['link'], '/'));
}
$variables_menuData['url']['link']  .= '/';
$variables_menuData['url']['app']   .= '/';
...
{
   include_once("variables_nmutf8.php");
}
...
include_once("variables_toolbar.php");
...
if ($_SESSION['scriptcase']['variables']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         ...
         {
             if (isset($_SESSION['scriptcase']['variables']['glo_nm_conexao']) && $_SESSION['scriptcase']['variables']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['variables']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['variables']['glo_nm_perfil']) && $_SESSION['scriptcase']['variables']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['variables']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['variables']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['variables']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
{
    $_SESSION['sc_session'][1]['variables']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['variables']['init']))
{
    $_SESSION['sc_session'][1]['variables']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['variables']['init'];
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_variables'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_variables'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_variables'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['variables']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['variables']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'variables'))
{
    $_SESSION['sc_session'][1]['variables']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_variables'] = "javascript:window.close()";
}
/* Menú de configuración de las variables */
$variables_menuData['iframe'] = TRUE;

if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_indicadores_1") . "/grid_indicadores_1_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_indicadores_1']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_indicadores_1'] = "on";
    }
}
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_indicadores_2") . "/grid_indicadores_2_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_indicadores_2']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_indicadores_2'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_variables'];
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_indicadores_1']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_indicadores_1']) == "on")
{
    $variables_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "|variables_form_php.php?sc_item_menu=item_1&sc_apl_menu=grid_indicadores_1&sc_apl_link=" . urlencode($variables_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['variables']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->variables_target('_self') . "|" . "\n";
}
else
{
    $variables_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_indicadores_2']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_indicadores_2']) == "on")
{
    $variables_menuData['data'] .= "item_2|.|" . $nm_var_lab[1] . "|variables_form_php.php?sc_item_menu=item_2&sc_apl_menu=grid_indicadores_2&sc_apl_link=" . urlencode($variables_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['variables']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->variables_target('_self') . "|" . "\n";
}
else
{
    $variables_menuData['data'] .= "item_2|.|" . $nm_var_lab[1] . "||||_self|disabled\n";
}

$variables_menuData['data'] = array();
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_indicadores_1']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_indicadores_1']) == "on")
{
    $variables_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[0] . "",
        'level'    => "0",
        'link'     => "variables_form_php.php?sc_item_menu=item_1&sc_apl_menu=grid_indicadores_1&sc_apl_link=" . urlencode($variables_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['variables']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[0] . "",
        'id'       => "item_1",
        'icon'     => "",
        'target'   => " item-target=\"" . $this->variables_target('_self') . "\"",
        'sc_id'    => "item_1",
        'disabled' => "N",
    );
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_indicadores_2']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_indicadores_2']) == "on")
{
    $variables_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[1] . "",
        'level'    => "0",
        'link'     => "variables_form_php.php?sc_item_menu=item_2&sc_apl_menu=grid_indicadores_2&sc_apl_link=" . urlencode($variables_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['variables']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[1] . "",
        'id'       => "item_2",
        'icon'     => "",
        'target'   => " item-target=\"" . $this->variables_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['variables']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['variables']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'variables');
    $variables_menuData['data'] = $str_menu_usu;
}
if (is_file("variables_help.txt"))
{
    $Arq_WebHelp = file("variables_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                $variables_menuData['data'][] = array(
                    ...
                    'id'       => "item_Help",
                    'icon'     => "",
                    'target'   => "" . $this->variables_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => "N",
                );
            }
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['variables']) && !empty($_SESSION['scriptcase']['sc_menu_del']['variables']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($variables_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['variables']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($variables_menuData['data'][$i_menu]);
       }
    ...
    $variables_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['variables']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['variables']))
{
    $disable_menu = false;
    foreach ($variables_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['variables']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $variables_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabecera HTML */
if ($variables_menuData['iframe'])
{
    $variables_menuData['height'] = '100%';
?>
...
{
    $variables_menuData['height'] = '30px';
}

/* Archivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['variables']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<?php
...
<div id="idDivMenu">
<?php
echo $this->variables_escreveMenu($variables_menuData['data']);
?>
</div>
<?php
/* Control de iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $variables_menuData); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
    <td style="border-width: 1px; height: 100%; padding: 0px">
      <iframe id="iframe_variables" name="variables_iframe" frameborder="0" class="scMenuIframe"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : $variables_menuData['url']['link'] . $this->tab_grupo['0']); ?><?php echo ($NM_scr_iframe != "" ? "" :"" . SC_dir_app_name('grid_indicadores_1') . "/?nm_run_menu=1&nm_apl_menu=variables&script_case_init=1&script_case_session=" . session_id() ); ?>" ></iframe>
<?php
}
?>
    </td>
...
/* Control de Target */
function variables_escreveMenu($arr_menu)
{
    $last      = '';
    $itemClass = ' topfirst';
    $subSize   = 2;
...
function variables_target($str_target)
{
    global $variables_menuData;
    ...
    elseif ($variables_menuData['iframe'])
    {
        return 'variables_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $variables_menuData)
{
}
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "variables_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($variables_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['variables']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "variables_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($variables_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['variables']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->variables_target( $arr_item['target']) : "_self"; 
           }
...
$contr_variables = new variables_class;
$contr_variables->variables_menu();
