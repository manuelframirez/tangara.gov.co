...
class variables_form_php
{
   ...
   function init()
   {
      ...
      //check prod
      if(!isset($_SESSION['scriptcase']['variables']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['variables']['glo_nm_path_prod']))
      {
...
<?php
      ...
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['variables'] as $id_item => $arr_item)
         {
      ...
      {
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "grid_indicadores_1")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_indicadores_1") . "/?nm_run_menu=1&nm_apl_menu=variables&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "grid_indicadores_2")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_indicadores_2") . "/?nm_run_menu=1&nm_apl_menu=variables&script_case_init=1&script_case_session=" . session_id() . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="variables"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "variables")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'variables', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
SC_dir_app_ini('tangara');
$controle = new variables_form_php();
$controle->init();
?>
