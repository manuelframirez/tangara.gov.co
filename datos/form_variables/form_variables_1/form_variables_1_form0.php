<?php
class form_variables_1_form extends form_variables_1_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['sc_redir_atualiz'] == 'ok')
{
?>
...
<?php
include_once("form_variables_1_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_variables_1_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['recarga'];
}
...
<?php
 include_once("form_variables_1_js0.php");
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['form_variables_1'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_variables_1'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['empty_filter'] = true;
       }
       echo "<tr><td>";
  }
?>
...
<?php
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['id_indicador_']) && $this->nmgp_cmp_hidden['id_indicador_'] == 'off') { $sStyleHidden_id_indicador_ = 'display: none'; }
    ...
    <TD class="scFormLabelOddMult" id="hidden_field_label_id_indicador_" style=";<?php echo $sStyleHidden_id_indicador_; ?>" > <?php echo $this->nm_new_label['id_indicador_'] ?> </TD>
   <?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['descripcion_']) && $this->nmgp_cmp_hidden['descripcion_'] == 'off') { $sStyleHidden_descripcion_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['descripcion_'])) {
          $this->nm_new_label['descripcion_'] = "Nombre de la variable"; } ?>
   ...
   <?php if ((!isset($this->nmgp_cmp_hidden['id_variable_']) || $this->nmgp_cmp_hidden['id_variable_'] == 'on') && ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir"))) { 
    ...
    <TD class="scFormLabelOddMult" id="hidden_field_label_id_variable_" style=";<?php echo $sStyleHidden_id_variable_; ?>" > <?php echo $this->nm_new_label['id_variable_'] ?> </TD>
   <?php }?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_variables_1);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_variables_1 = $this->form_vert_form_variables_1;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_variables_1))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_variables_1 as $sc_seq_vert => $sc_lixo)
   {
       $this->id_padre_ = $this->form_vert_form_variables_1[$sc_seq_vert]['id_padre_'];
       $this->final_ = $this->form_vert_form_variables_1[$sc_seq_vert]['final_'];
       $this->nivel_ = $this->form_vert_form_variables_1[$sc_seq_vert]['nivel_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->id_indicador_ = $this->form_vert_form_variables_1[$sc_seq_vert]['id_indicador_']; 
       ...
       $this->descripcion_ = $this->form_vert_form_variables_1[$sc_seq_vert]['descripcion_']; 
       ...
       $this->id_variable_ = $this->form_vert_form_variables_1[$sc_seq_vert]['id_variable_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_variables_1_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_variables_1_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_variables_1_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_variables_1_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_variables_1_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_variables_1_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult" id="hidden_field_data_id_indicador_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_id_indicador_; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult" style=";;vertical-align: top;padding: 0px">
...
ORDER BY Nombre";
   ...
   $x = 0; 
   echo "<span id=\"id_read_on_id_indicador_" . $sc_seq_vert . "\" style=\";" .  $sStyleReadLab_id_indicador_ . "\">" . NM_encode_input($id_indicador__look) . "</span><span id=\"id_read_off_id_indicador_" . $sc_seq_vert . "\" style=\"" . $sStyleReadInp_id_indicador_ . "\">";
   echo " <span id=\"idAjaxSelect_id_indicador_" .  $sc_seq_vert . "\"><select class=\"sc-js-input scFormObjectOddMult\" style=\";\" id=\"id_sc_field_id_indicador_" . $sc_seq_vert . "\" name=\"id_indicador_" . $sc_seq_vert . "\" size=1>" ; 
   echo "\r" ; 
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOddMult" id="hidden_field_data_id_variable_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_id_variable_; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult" style=";;vertical-align: top;padding: 0px"><span id="id_read_on_id_variable_<?php echo $sc_seq_vert ?>" style=";<?php echo $sStyleReadLab_id_variable_; ?>"><?php echo NM_encode_input($this->id_variable_); ?></span><span id="id_read_off_id_variable_<?php echo $sc_seq_vert ?>" style="<?php echo $sStyleReadInp_id_variable_; ?>"><input type=hidden id="id_sc_field_id_variable_<?php echo $sc_seq_vert ?>" name="id_variable_<?php echo $sc_seq_vert ?>" value="<?php echo NM_encode_input($id_variable_) . "\">"?><span id="id_ajax_label_id_variable_<?php echo $sc_seq_vert; ?>"><?php echo nl2br($id_variable_); ?></span>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_variables_1 = $guarda_form_vert_form_variables_1;
   } 
   if ($Table_refresh) 
   { 
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_variables_1']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bnovo", "do_ajax_form_variables_1_add_new_line(); return false;", "do_ajax_form_variables_1_add_new_line(); return false;", "sc_b_new_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_variables_1");
 parent.scAjaxDetailHeight("form_variables_1", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
