  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_variables_3" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_variables_3_validate_id_indicador()
  {
    var nomeCampo_id_indicador = "id_indicador";
    var var_id_indicador = scAjaxGetFieldSelect(nomeCampo_id_indicador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_variables_3_validate_id_indicador(var_id_indicador, var_script_case_init, do_ajax_form_variables_3_validate_id_indicador_cb);
  } // do_ajax_form_variables_3_validate_id_indicador

  function do_ajax_form_variables_3_validate_id_indicador_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_variables_3_validate_id_indicador_cb

  // ---------- Validate descripcion
  function do_ajax_form_variables_3_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_variables_3_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_variables_3_validate_descripcion_cb);
  } // do_ajax_form_variables_3_validate_descripcion

  function do_ajax_form_variables_3_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_variables_3_validate_descripcion_cb

  // ---------- Validate n2
  function do_ajax_form_variables_3_validate_n2()
  {
    var nomeCampo_n2 = "n2";
    var var_n2 = scAjaxGetFieldText(nomeCampo_n2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_variables_3_validate_n2(var_n2, var_script_case_init, do_ajax_form_variables_3_validate_n2_cb);
  } // do_ajax_form_variables_3_validate_n2

  function do_ajax_form_variables_3_validate_n2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "n2";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_variables_3_validate_n2_cb
  // ---------- Form
  function do_ajax_form_variables_3_submit_form()
  {
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_variables_3_submit_form(var_id_indicador, var_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_variables_3_submit_form_cb);
  } // do_ajax_form_variables_3_submit_form

  function do_ajax_form_variables_3_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_variables_3_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["form_variables_3_2"] = "off";

  function do_ajax_form_variables_3_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_variables_3_navigate_form(var_id_variable, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_variables_3_navigate_form_cb);
  } // do_ajax_form_variables_3_navigate_form

  function do_ajax_form_variables_3_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_variables_3_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_variables_3_navigate_form_cb
