...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_padre
  function do_ajax_form_variables_2_2_validate_id_padre()
  {
    var nomeCampo_id_padre = "id_padre";
    var var_id_padre = scAjaxGetFieldSelect(nomeCampo_id_padre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_variables_2_2_validate_id_padre(var_id_padre, var_script_case_init, do_ajax_form_variables_2_2_validate_id_padre_cb);
  } // do_ajax_form_variables_2_2_validate_id_padre

  function do_ajax_form_variables_2_2_validate_id_padre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_variables_2_2_validate_id_padre_cb

  // ---------- Validate descripcion
  function do_ajax_form_variables_2_2_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_variables_2_2_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_variables_2_2_validate_descripcion_cb);
  } // do_ajax_form_variables_2_2_validate_descripcion

  function do_ajax_form_variables_2_2_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_variables_2_2_validate_descripcion_cb
  // ---------- Form
  function do_ajax_form_variables_2_2_submit_form()
  {
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_variables_2_2_submit_form(var_id_padre, var_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_variables_2_2_submit_form_cb);
  ...
  function do_ajax_form_variables_2_2_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_variables_2_2_navigate_form(var_id_variable, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_variables_2_2_navigate_form_cb);
