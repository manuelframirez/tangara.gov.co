  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_variables_3_2_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_padre
  function do_ajax_form_variables_3_2_mob_validate_id_padre()
  {
    var nomeCampo_id_padre = "id_padre";
    var var_id_padre = scAjaxGetFieldSelect(nomeCampo_id_padre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_variables_3_2_mob_validate_id_padre(var_id_padre, var_script_case_init, do_ajax_form_variables_3_2_mob_validate_id_padre_cb);
  } // do_ajax_form_variables_3_2_mob_validate_id_padre

  function do_ajax_form_variables_3_2_mob_validate_id_padre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_padre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_variables_3_2_mob_validate_id_padre_cb

  // ---------- Validate descripcion
  function do_ajax_form_variables_3_2_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_variables_3_2_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_variables_3_2_mob_validate_descripcion_cb);
  } // do_ajax_form_variables_3_2_mob_validate_descripcion

  function do_ajax_form_variables_3_2_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_variables_3_2_mob_validate_descripcion_cb

  // ---------- Validate n3
  function do_ajax_form_variables_3_2_mob_validate_n3()
  {
    var nomeCampo_n3 = "n3";
    var var_n3 = scAjaxGetFieldText(nomeCampo_n3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_variables_3_2_mob_validate_n3(var_n3, var_script_case_init, do_ajax_form_variables_3_2_mob_validate_n3_cb);
  } // do_ajax_form_variables_3_2_mob_validate_n3

  function do_ajax_form_variables_3_2_mob_validate_n3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "n3";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_variables_3_2_mob_validate_n3_cb
  // ---------- Form
  function do_ajax_form_variables_3_2_mob_submit_form()
  {
    scAjaxHideMessage();
    var var_id_padre = scAjaxGetFieldSelect("id_padre");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_variables_3_2_mob_submit_form(var_id_padre, var_descripcion, var_id_variable, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_variables_3_2_mob_submit_form_cb);
  } // do_ajax_form_variables_3_2_mob_submit_form

  function do_ajax_form_variables_3_2_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_padre");
      scAjaxHideErrorDisplay("descripcion");
      scAjaxHideErrorDisplay("n3");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_variables_3_2_mob_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["form_variables_3_3"] = "off";

  function do_ajax_form_variables_3_2_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_variables_3_3"] = "on";
    x_ajax_form_variables_3_2_mob_navigate_form(var_id_variable, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_variables_3_2_mob_navigate_form_cb);
  } // do_ajax_form_variables_3_2_mob_navigate_form

  function do_ajax_form_variables_3_2_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    document.getElementById('nmsc_iframe_liga_form_variables_3_3').contentWindow.nm_move('apl_detalhe', true, '320px');
    document.getElementById('nmsc_iframe_liga_form_variables_3_3').style.height = "320px";
    document.getElementById('nmsc_iframe_liga_form_variables_3_3').style.display = "none";
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert();
    scAjaxMessage();
...
{
?>
    do_ajax_form_variables_3_2_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_variables_3_2_mob_navigate_form_cb
  ...
  {
    if ("off" == scStatusDetail["form_variables_3_3"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "id_padre";
  ajax_field_list[1] = "descripcion";
  ajax_field_list[2] = "n3";
  ...
  var ajax_error_list = {
    "id_padre": {"label": "Id Padre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "n3": {"label": "n3", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["id_padre"][1] = "id_padre";
  ajax_field_mult["descripcion"][1] = "descripcion";
  ajax_field_mult["n3"][1] = "n3";

  var ajax_field_id = {
    "id_padre": new Array("hidden_field_label_id_padre", "hidden_field_data_id_padre"),
    "descripcion": new Array("hidden_field_label_descripcion", "hidden_field_data_descripcion"),
    "n3": new Array("hidden_field_label_n3", "hidden_field_data_n3")
  };
