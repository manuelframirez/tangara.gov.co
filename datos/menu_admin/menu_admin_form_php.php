...
<?php
      ...
      {
		  if ($_SESSION['scriptcase']['sc_apl_menu'] == "Crear_Niveles")
		  {
			  $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("Crear_Niveles") . "/?nm_run_menu=1&nm_apl_menu=menu_admin&script_case_init=1&script_case_session=" . session_id() . "";
		  }
		  if ($_SESSION['scriptcase']['sc_apl_menu'] == "Ingresar_datos")
		  {
			  $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("Ingresar_datos") . "/?nm_run_menu=1&nm_apl_menu=menu_admin&script_case_init=1&script_case_session=" . session_id() . "";
		  }
		  if ($_SESSION['scriptcase']['sc_apl_menu'] == "Modificar_variable")
		  {
			  $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("Modificar_variable") . "/?nm_run_menu=1&nm_apl_menu=menu_admin&script_case_init=1&script_case_session=" . session_id() . "";
		  }
		  if ($_SESSION['scriptcase']['sc_apl_menu'] == "form_categorias")
		  {
			  $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_categorias") . "/?nm_run_menu=1&nm_apl_menu=menu_admin&script_case_init=1&script_case_session=" . session_id() . "";
		  }
		  if ($_SESSION['scriptcase']['sc_apl_menu'] == "form_tipo_categoria")
		  {
			  $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_tipo_categoria") . "/?nm_run_menu=1&nm_apl_menu=menu_admin&script_case_init=1&script_case_session=" . session_id() . "";
		  }
		  if ($_SESSION['scriptcase']['sc_apl_menu'] == "Archivos_eliminar")
		  {
			  $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("Archivos_eliminar") . "/?nm_run_menu=1&nm_apl_menu=menu_admin&script_case_init=1&script_case_session=" . session_id() . "";
		  }
		  if ($_SESSION['scriptcase']['sc_apl_menu'] == "Archivos_Subir")
		  {
			  $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("Archivos_Subir") . "/?nm_run_menu=1&nm_apl_menu=menu_admin&script_case_init=1&script_case_session=" . session_id() . "";
		  }
      }
      if (!$link_url)
      {
