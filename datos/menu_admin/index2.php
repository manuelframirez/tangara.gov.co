...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Modificar_variable") . "/Modificar_variable_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Modificar_variable']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['Modificar_variable'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tipo_categoria") . "/form_tipo_categoria_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipo_categoria']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_tipo_categoria'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Archivos_eliminar") . "/form_categorias_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Archivos_eliminar']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['Archivos_eliminar'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[1]))
{
 ...
 $nm_var_lab[2] = "Modificar variables";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[3]))
{
 ...
 $nm_var_lab[4] = "Tipo de categorias";
...
{
    $_SESSION['scriptcase']['menu_mobile'] = "menu_admin";
    include('menu_admin_mobile.php');
    exit;
}
/* Cabecera HTML */
...
<link rel="stylesheet" type="text/css" href="../_lib/css/_menuTheme/scriptcase_Android_Blue_hor.css<?php if (@is_file($this->path_css . '_menuTheme/' . scriptcase_Android_Blue . '_' . hor . '.css')) { echo '?scp=' . md5($this->path_css . '_menuTheme/' . scriptcase_Android_Blue . '_' . hor . '.css'); } ?>" />
</head>
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['Crear_Niveles']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Crear_Niveles']) == "on")
{
    $menu_admin_menuData['data'][] = array(
        ...
        'id'       => "item_1",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_admin_target('_self') . "\"",
        'sc_id'    => "item_1",
        'disabled' => "N",
    );
}
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['Modificar_variable']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Modificar_variable']) == "on")
{
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[2] . "",
        'level'    => "0",
        'link'     => "menu_admin_form_php.php?sc_item_menu=item_3&sc_apl_menu=Modificar_variable&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[2] . "",
        'id'       => "item_3",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_admin_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_categorias']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_categorias']) == "on")
{
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[3] . "",
        'level'    => "0",
        'link'     => "menu_admin_form_php.php?sc_item_menu=item_4&sc_apl_menu=form_categorias&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[3] . "",
        'id'       => "item_4",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_admin_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipo_categoria']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tipo_categoria']) == "on")
{
    $menu_admin_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[4] . "",
        'level'    => "0",
        'link'     => "menu_admin_form_php.php?sc_item_menu=item_5&sc_apl_menu=form_tipo_categoria&sc_apl_link=" . urlencode($menu_admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_admin']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[4] . "",
        'id'       => "item_5",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_admin_target('_self') . "\"",
