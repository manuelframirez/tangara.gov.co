  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_acerca_tangara_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate acerca_tangara
  function do_ajax_form_acerca_tangara_mob_validate_acerca_tangara()
  {
    var nomeCampo_acerca_tangara = "acerca_tangara";
    var var_acerca_tangara = scAjaxGetFieldEditorHtml(nomeCampo_acerca_tangara);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_acerca_tangara_mob_validate_acerca_tangara(var_acerca_tangara, var_script_case_init, do_ajax_form_acerca_tangara_mob_validate_acerca_tangara_cb);
  } // do_ajax_form_acerca_tangara_mob_validate_acerca_tangara

  function do_ajax_form_acerca_tangara_mob_validate_acerca_tangara_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "acerca_tangara";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_acerca_tangara_mob_validate_acerca_tangara_cb
  // ---------- Form
  function do_ajax_form_acerca_tangara_mob_submit_form()
  {
    scAjaxHideMessage();
    var var_acerca_tangara = scAjaxGetFieldEditorHtml("acerca_tangara");
    var var_id_contenido = scAjaxGetFieldText("id_contenido");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_acerca_tangara_mob_submit_form(var_acerca_tangara, var_id_contenido, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_acerca_tangara_mob_submit_form_cb);
  } // do_ajax_form_acerca_tangara_mob_submit_form

  function do_ajax_form_acerca_tangara_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("acerca_tangara");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_acerca_tangara_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_acerca_tangara_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("table");
    scAjaxHideErrorDisplay("acerca_tangara");
    var var_id_contenido = document.F2.id_contenido.value;
    ...
    scAjaxProcOn();
    x_ajax_form_acerca_tangara_mob_navigate_form(var_id_contenido, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_acerca_tangara_mob_navigate_form_cb);
  } // do_ajax_form_acerca_tangara_mob_navigate_form

  function do_ajax_form_acerca_tangara_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_contenido.value = scAjaxGetKeyValue("id_contenido");
    scAjaxSetSummary();
    scAjaxShowDebug();
...
{
?>
    do_ajax_form_acerca_tangara_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_acerca_tangara_mob_navigate_form_cb
  ...
  ajax_field_list[0] = "acerca_tangara";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "acerca_tangara": {"label": "Acerca de Tángara", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "acerca_tangara": new Array()
  };
  ajax_field_mult["acerca_tangara"][1] = "acerca_tangara";

  var ajax_field_id = {
    "acerca_tangara": new Array("hidden_field_label_acerca_tangara", "hidden_field_data_acerca_tangara")
  };
