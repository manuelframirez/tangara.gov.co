...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_fuente']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
</form> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_fuente']['where_detal']))
  {
?>  
...
{ 
   ...
   document.F4.action               = "buscar_fuente_fim.php";
   document.F4.submit(); 
} 
