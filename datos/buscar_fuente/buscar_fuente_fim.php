...
//----- 
   ...
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_fuente']))
   {
      unset($_SESSION['sc_session'][$script_case_init]['buscar_fuente']['sc_redir_atualiz']);
      unset($_SESSION['sc_session'][$script_case_init]['buscar_fuente']['sc_redir_insert']);
   }
   $fecha_janela = false;
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_fuente']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['buscar_fuente']['sc_outra_jan'])
   {
       $fecha_janela = true;
   }
   if ((isset($nmgp_parms) && $nmgp_parms == "glo_menu") || $fecha_janela)
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_fuente']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['buscar_fuente']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['buscar_fuente']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['buscar_fuente']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['buscar_fuente']['db_changed'])
           {
       ...
       {
           if (!isset($script_case_init) || is_array($script_case_init) || !isset($_SESSION['sc_session'][$script_case_init]['buscar_fuente']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['buscar_fuente']['db_changed'])
           {
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['buscar_fuente']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['buscar_fuente']['embutida_filho'] as $ind => $sc_init)
          {
