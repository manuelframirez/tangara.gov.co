  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_buscar_fuente" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_buscar_fuente_validate_id_indicador()
  {
    var nomeCampo_id_indicador = "id_indicador";
    var var_id_indicador = scAjaxGetFieldSelect(nomeCampo_id_indicador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_buscar_fuente_validate_id_indicador(var_id_indicador, var_script_case_init, do_ajax_buscar_fuente_validate_id_indicador_cb);
  } // do_ajax_buscar_fuente_validate_id_indicador

  function do_ajax_buscar_fuente_validate_id_indicador_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_buscar_fuente_validate_id_indicador_cb

  // ---------- Validate id_municipio
  function do_ajax_buscar_fuente_validate_id_municipio()
  {
    var nomeCampo_id_municipio = "id_municipio";
    var var_id_municipio = scAjaxGetFieldSelect(nomeCampo_id_municipio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_buscar_fuente_validate_id_municipio(var_id_municipio, var_script_case_init, do_ajax_buscar_fuente_validate_id_municipio_cb);
  } // do_ajax_buscar_fuente_validate_id_municipio

  function do_ajax_buscar_fuente_validate_id_municipio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_buscar_fuente_validate_id_municipio_cb
  // ---------- Form
  function do_ajax_buscar_fuente_submit_form()
  {
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_buscar_fuente_submit_form(var_id_indicador, var_id_municipio, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_buscar_fuente_submit_form_cb);
  } // do_ajax_buscar_fuente_submit_form

  function do_ajax_buscar_fuente_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_buscar_fuente_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_buscar_fuente_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_buscar_fuente_navigate_form

  function do_ajax_buscar_fuente_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_buscar_fuente_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_buscar_fuente_navigate_form_cb
