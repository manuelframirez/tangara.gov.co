  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Modificar_variable" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate indicador
  function do_ajax_Modificar_variable_validate_indicador()
  {
    var nomeCampo_indicador = "indicador";
    var var_indicador = scAjaxGetFieldSelect(nomeCampo_indicador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Modificar_variable_validate_indicador(var_indicador, var_script_case_init, do_ajax_Modificar_variable_validate_indicador_cb);
  } // do_ajax_Modificar_variable_validate_indicador

  function do_ajax_Modificar_variable_validate_indicador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "indicador";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Modificar_variable_validate_indicador_cb
  // ---------- Form
  function do_ajax_Modificar_variable_submit_form()
  {
    scAjaxHideMessage();
    var var_indicador = scAjaxGetFieldSelect("indicador");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_Modificar_variable_submit_form(var_indicador, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_Modificar_variable_submit_form_cb);
  } // do_ajax_Modificar_variable_submit_form

  function do_ajax_Modificar_variable_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_Modificar_variable_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_Modificar_variable_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_Modificar_variable_navigate_form

  function do_ajax_Modificar_variable_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sc_mupload_ok = true;
...
{
?>
    do_ajax_Modificar_variable_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_Modificar_variable_navigate_form_cb
  ...
  ajax_field_list[0] = "indicador";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "indicador": {"label": "Seleccione indicador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["indicador"][1] = "indicador";

  var ajax_field_id = {
    "indicador": new Array("hidden_field_label_indicador", "hidden_field_data_indicador")
  };
