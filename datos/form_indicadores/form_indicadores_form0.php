...
<?php
include_once("form_indicadores_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_indicadores_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['recarga'];
}
?>
...
<?php
 include_once("form_indicadores_js0.php");
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['form_indicadores'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_indicadores'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "balterar", "nm_atualiza ('alterar');", "nm_atualiza ('alterar');", "sc_b_upd_t", "", "Guardar", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_fk_tematica" style="<?php echo $sStyleHidden_fk_tematica; ?>;"><span id="id_label_fk_tematica"><?php echo $this->nm_new_label['fk_tematica']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['php_cmp_required']['fk_tematica']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['php_cmp_required']['fk_tematica'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_nombre" style="<?php echo $sStyleHidden_nombre; ?>;"><span id="id_label_nombre"><?php echo $this->nm_new_label['nombre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['php_cmp_required']['nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['php_cmp_required']['nombre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores']['total'] + 1)?>);</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_indicadores");
 parent.scAjaxDetailHeight("form_indicadores", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
