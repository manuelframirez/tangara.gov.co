...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Indicadores"); } else { echo strip_tags("Indicadores"); } ?></TITLE>
...
<?php
include_once("form_indicadores_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_indicadores_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores_mob']['recarga'];
}
?>
...
<?php
 include_once("form_indicadores_mob_js0.php");
?>
...
<form name="F1" method="post" 
               action="form_indicadores_mob.php" 
               target="_self"> 
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores_mob']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['form_indicadores_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_indicadores_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_fk_tematica" style="<?php echo $sStyleHidden_fk_tematica; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_fk_tematica"><?php echo $this->nm_new_label['fk_tematica']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores_mob']['php_cmp_required']['fk_tematica']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores_mob']['php_cmp_required']['fk_tematica'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   {
       $this->nm_new_label['fk_tipo_categoria'] = "Categorias";
   }
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_nombre" style="<?php echo $sStyleHidden_nombre; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_nombre"><?php echo $this->nm_new_label['nombre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores_mob']['php_cmp_required']['nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores_mob']['php_cmp_required']['nombre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<span id="id_read_on_nombre" class="sc-ui-readonly-nombre" style=";<?php echo $sStyleReadLab_nombre; ?>"><?php echo NM_encode_input($this->nombre); ?></span><span id="id_read_off_nombre" style="white-space: nowrap;<?php echo $sStyleReadInp_nombre; ?>">
 ...
 size=70 maxlength=150 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_descripcion" class="sc-ui-readonly-descripcion" style=";<?php echo $sStyleReadLab_descripcion; ?>"><?php echo NM_encode_input($this->descripcion); ?></span><span id="id_read_off_descripcion" style="white-space: nowrap;<?php echo $sStyleReadInp_descripcion; ?>">
 ...
 size=70 maxlength=200 alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_indicadores_mob']['run_iframe'] != "R")
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_indicadores_mob");
 parent.scAjaxDetailHeight("form_indicadores_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
