  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_agregar_fuente_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_fuente
  function do_ajax_form_agregar_fuente_mob_validate_id_fuente()
  {
    var nomeCampo_id_fuente = "id_fuente";
    var var_id_fuente = scAjaxGetFieldHidden(nomeCampo_id_fuente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agregar_fuente_mob_validate_id_fuente(var_id_fuente, var_script_case_init, do_ajax_form_agregar_fuente_mob_validate_id_fuente_cb);
  } // do_ajax_form_agregar_fuente_mob_validate_id_fuente

  function do_ajax_form_agregar_fuente_mob_validate_id_fuente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_fuente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agregar_fuente_mob_validate_id_fuente_cb

  // ---------- Validate id_municipio
  function do_ajax_form_agregar_fuente_mob_validate_id_municipio()
  {
    var nomeCampo_id_municipio = "id_municipio";
    var var_id_municipio = scAjaxGetFieldSelect(nomeCampo_id_municipio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agregar_fuente_mob_validate_id_municipio(var_id_municipio, var_script_case_init, do_ajax_form_agregar_fuente_mob_validate_id_municipio_cb);
  } // do_ajax_form_agregar_fuente_mob_validate_id_municipio

  function do_ajax_form_agregar_fuente_mob_validate_id_municipio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agregar_fuente_mob_validate_id_municipio_cb

  // ---------- Validate id_indicador
  function do_ajax_form_agregar_fuente_mob_validate_id_indicador()
  {
    var nomeCampo_id_indicador = "id_indicador";
    var var_id_indicador = scAjaxGetFieldSelect(nomeCampo_id_indicador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agregar_fuente_mob_validate_id_indicador(var_id_indicador, var_script_case_init, do_ajax_form_agregar_fuente_mob_validate_id_indicador_cb);
  } // do_ajax_form_agregar_fuente_mob_validate_id_indicador

  function do_ajax_form_agregar_fuente_mob_validate_id_indicador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_indicador";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agregar_fuente_mob_validate_id_indicador_cb

  // ---------- Validate texto_fuente
  function do_ajax_form_agregar_fuente_mob_validate_texto_fuente()
  {
    var nomeCampo_texto_fuente = "texto_fuente";
    var var_texto_fuente = scAjaxGetFieldEditorHtml(nomeCampo_texto_fuente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agregar_fuente_mob_validate_texto_fuente(var_texto_fuente, var_script_case_init, do_ajax_form_agregar_fuente_mob_validate_texto_fuente_cb);
  } // do_ajax_form_agregar_fuente_mob_validate_texto_fuente

  function do_ajax_form_agregar_fuente_mob_validate_texto_fuente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agregar_fuente_mob_validate_texto_fuente_cb
  // ---------- Form
  function do_ajax_form_agregar_fuente_mob_submit_form()
  {
    scAjaxHideMessage();
    var var_id_fuente = scAjaxGetFieldHidden("id_fuente");
    var var_id_municipio = scAjaxGetFieldSelect("id_municipio");
    var var_id_indicador = scAjaxGetFieldSelect("id_indicador");
    var var_texto_fuente = scAjaxGetFieldEditorHtml("texto_fuente");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_agregar_fuente_mob_submit_form(var_id_fuente, var_id_municipio, var_id_indicador, var_texto_fuente, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_agregar_fuente_mob_submit_form_cb);
  } // do_ajax_form_agregar_fuente_mob_submit_form

  function do_ajax_form_agregar_fuente_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_fuente");
      scAjaxHideErrorDisplay("id_municipio");
      scAjaxHideErrorDisplay("id_indicador");
  ...
  } // do_ajax_form_agregar_fuente_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_agregar_fuente_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("id_indicador");
    scAjaxHideErrorDisplay("texto_fuente");
    var var_id_fuente = document.F2.id_fuente.value;
    ...
    scAjaxProcOn();
    x_ajax_form_agregar_fuente_mob_navigate_form(var_id_fuente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_agregar_fuente_mob_navigate_form_cb);
  } // do_ajax_form_agregar_fuente_mob_navigate_form

  function do_ajax_form_agregar_fuente_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_fuente.value = scAjaxGetKeyValue("id_fuente");
    scAjaxSetSummary();
    scAjaxShowDebug();
...
{
?>
    do_ajax_form_agregar_fuente_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_agregar_fuente_mob_navigate_form_cb
  ...
  ajax_field_list[0] = "id_fuente";
  ajax_field_list[1] = "id_municipio";
  ajax_field_list[2] = "id_indicador";
  ajax_field_list[3] = "texto_fuente";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_fuente": {"label": "Id Fuente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_municipio": {"label": "Municipio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_indicador": {"label": "Indicador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "texto_fuente": {"label": "Texto Fuente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "id_indicador": new Array(),
    "texto_fuente": new Array()
  };
  ajax_field_mult["id_fuente"][1] = "id_fuente";
  ajax_field_mult["id_municipio"][1] = "id_municipio";
  ajax_field_mult["id_indicador"][1] = "id_indicador";
  ajax_field_mult["texto_fuente"][1] = "texto_fuente";

  var ajax_field_id = {
    "id_fuente": new Array("hidden_field_label_id_fuente", "hidden_field_data_id_fuente"),
    "id_municipio": new Array("hidden_field_label_id_municipio", "hidden_field_data_id_municipio"),
    "id_indicador": new Array("hidden_field_label_id_indicador", "hidden_field_data_id_indicador"),
