  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tematica_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate fk_dimension
  function do_ajax_form_tematica_mob_validate_fk_dimension()
  {
    var nomeCampo_fk_dimension = "fk_dimension";
    var var_fk_dimension = scAjaxGetFieldSelect(nomeCampo_fk_dimension);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tematica_mob_validate_fk_dimension(var_fk_dimension, var_script_case_init, do_ajax_form_tematica_mob_validate_fk_dimension_cb);
  } // do_ajax_form_tematica_mob_validate_fk_dimension

  function do_ajax_form_tematica_mob_validate_fk_dimension_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fk_dimension";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tematica_mob_validate_fk_dimension_cb

  // ---------- Validate descripcion
  function do_ajax_form_tematica_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tematica_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_tematica_mob_validate_descripcion_cb);
  } // do_ajax_form_tematica_mob_validate_descripcion

  function do_ajax_form_tematica_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tematica_mob_validate_descripcion_cb
  // ---------- Form
  function do_ajax_form_tematica_mob_submit_form()
  {
    scAjaxHideMessage();
    var var_fk_dimension = scAjaxGetFieldSelect("fk_dimension");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_id_tematica = scAjaxGetFieldText("id_tematica");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tematica_mob_submit_form(var_fk_dimension, var_descripcion, var_id_tematica, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_tematica_mob_submit_form_cb);
  } // do_ajax_form_tematica_mob_submit_form

  function do_ajax_form_tematica_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("fk_dimension");
  ...
  } // do_ajax_form_tematica_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tematica_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("fk_dimension");
    scAjaxHideErrorDisplay("descripcion");
    var var_id_tematica = document.F2.id_tematica.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tematica_mob_navigate_form(var_id_tematica, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tematica_mob_navigate_form_cb);
  } // do_ajax_form_tematica_mob_navigate_form

  function do_ajax_form_tematica_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_tematica.value = scAjaxGetKeyValue("id_tematica");
    scAjaxShowDebug();
...
{
?>
    do_ajax_form_tematica_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tematica_mob_navigate_form_cb
  ...
  ajax_field_list[0] = "fk_dimension";
  ...
  var ajax_error_list = {
    "fk_dimension": {"label": "Dimensión", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "fk_dimension": new Array(),
    "descripcion": new Array()
  };
  ajax_field_mult["fk_dimension"][1] = "fk_dimension";
  ajax_field_mult["descripcion"][1] = "descripcion";

  var ajax_field_id = {
    "fk_dimension": new Array("hidden_field_label_fk_dimension", "hidden_field_data_fk_dimension"),
