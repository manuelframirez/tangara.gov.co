  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tematica" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tematica_validate_fk_dimension()
  {
    var nomeCampo_fk_dimension = "fk_dimension";
    var var_fk_dimension = scAjaxGetFieldSelect(nomeCampo_fk_dimension);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tematica_validate_fk_dimension(var_fk_dimension, var_script_case_init, do_ajax_form_tematica_validate_fk_dimension_cb);
  } // do_ajax_form_tematica_validate_fk_dimension

  function do_ajax_form_tematica_validate_fk_dimension_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tematica_validate_fk_dimension_cb

  // ---------- Validate descripcion
  function do_ajax_form_tematica_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tematica_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_tematica_validate_descripcion_cb);
  } // do_ajax_form_tematica_validate_descripcion

  function do_ajax_form_tematica_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tematica_validate_descripcion_cb
  // ---------- Form
  function do_ajax_form_tematica_submit_form()
  {
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tematica_submit_form(var_fk_dimension, var_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_tematica_submit_form_cb);
  } // do_ajax_form_tematica_submit_form

  function do_ajax_form_tematica_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tematica_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tematica_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tematica_navigate_form(var_id_tematica, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tematica_navigate_form_cb);
  } // do_ajax_form_tematica_navigate_form

  function do_ajax_form_tematica_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_tematica_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tematica_navigate_form_cb
