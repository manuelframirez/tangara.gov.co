...
<table cellpadding="1" cellspacing="6" border="0" align="center" width="500px">
	<tr>
		<td align="center">
			...
			?>
			 <tr>
			  <td class="nmLineV3" align="right" width="50%"><?php echo $nm_lang['form_pass_old']; ?>&nbsp;&nbsp;</td>
			  <td class="nmLineV3" width="50%"><input type="password" name="field_pass_old" size="20" class="nmInput" /></td>
			 </tr>
			 <tr>
			...
			?>
			 ...
			 <tr>
			  ...
			  <td class="nmLineV3" width="50%"><input type="password" name="field_pass_new" size="20" class="nmInput" /></td>
			 </tr>
			 <!--tr class="nmTableLine">
			   <td height="1" colspan="2"><img src="../../nm_transparent.gif" width="1" height="1"></td>
			 </tr-->
			 ...
			 <tr>
			  ...
			  <td class="nmLineV3"><input type="password" name="field_pass_conf" size="20" class="nmInput" /></td>
			 </tr>
			 <tr>
			  <td colspan="2">&nbsp;</td>
			 </tr>
			...
			<input type="button" value="<?php echo $nm_lang['button_change']; ?>" onclick="nm_set_option('change_pass', '', 'nm_iframe')" class="nmButton" >
			<?php
			    if (('' != $v_str_pass) && ('scriptcase' != $v_str_pass))
			    {
			?>
			&nbsp;&nbsp;&nbsp;<input type="button" value="<?php echo $nm_lang['button_cancel']; ?>" onClick="nm_set_option('main_menu', '', '_top')" class="nmButton" />
			<?php
			    }
			?>
			</center>
...
<table class="nmTable" cellpadding="3px">
 ...
 <tr><td colspan="5" style="font-size:3px">&nbsp;</td></tr>
 <tr>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
  <td class="nmLineV3 pad" ><?php echo $nm_lang['form_gc_dir']; ?></td>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
  <td class="nmLineV3 pad"><input type="text" name="field_gc_dir" size="50" value="<?php echo $arr_ini['GLOBAL']['GC_DIR']; ?>" class="nmInput" /></td>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
 </tr>
 <tr>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
  ...
  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
  <td class="nmLineV3 pad"><input type="text" name="field_gc_min" size="5" value="<?php echo $arr_ini['GLOBAL']['GC_MIN']; ?>" class="nmInput" /></td>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
 </tr>
<tr>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
  ...
  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
  <td class="nmLineV3 pad"><input type="text" name="field_pdf_server_wkhtml" size="50" value="<?php echo $arr_ini['GLOBAL']['PDF_SERVER_WKHTML']; ?>" class="nmInput" /></td>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
 </tr>
 <tr>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
?>
    <option value="<?php echo $str_code; ?>"<?php echo $str_sel; ?>><?php echo $str_lang; ?></option>
<?php
    }
?>
   </select>
 ...
 <tr>
  ...
  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
  <td class="nmLineV3 pad"><input type="text" name="field_googlemaps_api_key" size="25" value="<?php echo (isset($arr_ini['GLOBAL']['GOOGLEMAPS_API_KEY']) ? $arr_ini['GLOBAL']['GOOGLEMAPS_API_KEY'] : ""); ?>" class="nmInput" /></td>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
 </tr>
 <tr><td colspan="5" style="font-size:3px">&nbsp;</td></tr>
</table>
...
<input type="button" style='min-width:68px;' value="<?php echo $nm_lang['button_save']; ?>" onclick="nm_set_option('environment', '', 'nm_iframe')" class="nmButton" >&nbsp;&nbsp;&nbsp;
<input type="button" style='min-width:68px;' value="<?php echo $nm_lang['button_cancel']; ?>" onClick="nm_set_option('main_menu', '', '_top')" class="nmButton" />
</center>
</div>
...
<body class="nmPage">
<form name="form_prod" action="<?php echo nm_prod_url_rand($nm_config['url_lib'] . 'nm_ini_manager2.php'); ?>" method="post" target="_top">
...
?>
	<style>
		html, body { margin: 0; padding: 0; height: 100%; width: 100%; background: #bfd1e3 url(../../img/bgLogin.jpg) repeat-x; }
	</style>
...
<table cellpadding=0 cellspacing=0 border=0 id="loginContainer" align='center'>
    <tr>
        <td style='height: 89%'>
			<!-- logo -->
			<div id="loginPartsLogo"><img src="../../img/logoLogin8.png" width="346" height="85" alt="Scriptcase" title="Scriptcase" /></div>
			<!-- xx logo -->
						...
						<div id="loginBoxForm">
							...
							<table cellpadding="8" cellspacing="4" border="0">
								...
								<tr>
									...
									<td valign="middle" class="nmText">
										<select name="field_language" class="nmInput" onChange="document.form_prod.submit()" />
											<?php
												foreach ($arr_lang as $str_code => $str_lang)
												{
													$str_sel = ($str_comp == $str_code) ? ' selected="selected"' : '';
					...
					<div id="loginPartsInfos">
						<span class="nmLoginErroMsg" style="display: none" id="id_erro_msg"><?php echo $str_msg_login; ?></span>
...
function nm_prod_display_main_menu($b_msg)
{
    global $nm_config, $nm_lang;
?>
<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" height="97%" style="border-collapse:collapse;" class="nmPageTop">
	<tr  class="nmMenuLine"">
	...
	<tr>
		<td width="300" valign="top" style="padding:10px" class="nmTable">
			...
			<table class="nmTable" cellpadding="0" cellspacing="0" width="100%">
			 ...
			 <tr class="nmTableTd">
			  <td class="nmLineV3">
			  &nbsp;&nbsp;<a href="javascript: nm_set_option('profile_new', '', 'nm_iframe')" title="<?php echo $nm_lang['hint_profile_new']; ?>" class="nmText"><?php       echo $nm_lang['main_profile_new'];    ?></a>
			  </td>
			 </tr>
			 <tr class="nmTableTd">
			  <td class="nmLineV3">
			  &nbsp;&nbsp;<a href="javascript: nm_set_option('profile_edit', '', 'nm_iframe')" title="<?php echo $nm_lang['hint_profile_edit']; ?>" class="nmText"><?php     echo $nm_lang['main_profile_edit'];   ?></a>
			  </td>
			 </tr>
			 <tr class="nmTableTd">
			  <td class="nmLineV3">
			  &nbsp;&nbsp;<a href="javascript: nm_set_option('profile_rename', '', 'nm_iframe')" title="<?php echo $nm_lang['hint_profile_rename']; ?>" class="nmText"><?php echo $nm_lang['main_profile_rename']; ?></a>
			  </td>
			 </tr>
			 <!--tr class="nmTableTd">
			  <td class="nmLineV3">
			...
			<table class="nmTable" cellpadding="0" cellspacing="0" width="100%">
			 ...
			 <tr class="nmTableTd">
			  <td class="nmLineV3">
			  &nbsp;&nbsp;<a href="javascript: nm_set_option('environment', '', 'nm_iframe')" title="<?php echo $nm_lang['hint_environment']; ?>" class="nmText"><?php       echo $nm_lang['main_environment'];    ?></a>
			  </td>
			 <tr class="nmTableTd">
			  <td class="nmLineV3">
			  &nbsp;&nbsp;<a href="javascript: nm_set_option('change_pass', '', 'nm_iframe')" title="<?php echo $nm_lang['hint_change_pass']; ?>" class="nmText"><?php       echo $nm_lang['main_password'];       ?></a>
			  </td>
			 </tr>
			 <tr class="nmTableTd">
			  <td class="nmLineV3">
			  <?php
				...
				{
					case "pt-br": $str_lang = "pt_br"; break;
					case "es-es": $str_lang = "es_es"; break;
					default:      $str_lang = "en_us"; break;
				}
			 	...
			 	{
			  ?>
			  &nbsp;&nbsp;<a href="http://downloads.scriptcase.net/downloads/v7/manual/<?php echo $str_lang; ?>/webhelp/manual_mp/manual_mp.htm?item=30-Publicando_Aplicacoes/01-tipica.html" title="<?php echo $nm_lang['lbl_help'];  ?>" class="nmText" target="_blank"><?php echo $nm_lang['lbl_help'];  ?></a>
			  <?php
			 	}
			  	else
			  	{
			  ?>
			  &nbsp;&nbsp;<a href="javascript:alert('<?php echo html_entity_decode($nm_lang['msg_not_internet']); ?>');" title="<?php echo $nm_lang['lbl_help'];  ?>" class="nmText"><?php echo $nm_lang['lbl_help'];  ?></a>
			  <?php
			  	}
			  ?>
			  </td>
			 ...
			 <tr class="nmTableTd">
			  <td class="nmLineV3">
			  &nbsp;&nbsp;<a href="javascript: nm_set_option('logout', '', '_top')" title="<?php echo $nm_lang['hint_logout']; ?>" class="nmText"><?php                 echo $nm_lang['main_logout'];         ?></a>
			  </td>
			 </tr>
			</table>
		</td>
		<td valign="top" align="center" style="height:100%;padding: 10px;" class="nmTable">
			...
			?>
			<iframe name="nm_iframe" id="id_iframe" width="100%" height="100%" src="<?php echo nm_prod_url_rand($nm_config['url_lib'] . 'nm_ini_manager2.php?option=msg&msg=' . urlencode($str_msg)); ?>" frameborder="0" style="border-style: none; border-width: 0px;margin:0px; padding: 0px;"></iframe>
			<?php
				}
				else
				{
			?>
			<iframe name="nm_iframe" id="id_iframe" width="100%" height="100%" src="../../img/index.html" frameborder="0" style="border-style: none; border-width: 0px;margin:0px; padding: 0px;"></iframe>
			<?php
				}
			?>
...
<table cellpadding="0" cellspacing="0" border="0" align="center" style="border-collapse:collapse;">
	...
	<tr>
		<td>
		   ...
		   <table>
		    <tr>
		     <td class="nmOddText" style="padding: 4px 10px" colspan="<?php echo $int_col_total; ?>"><?php echo $nm_lang['main_warn_conn']; ?></td>
		    </tr>
		<?php
		        $int_col_count = 0;
		...
		<?php
		            ...
		            $int_con_count++;
		?>
		     <td class="nmOddText" style="padding: 4px 10px; text-align: center; width: <?php echo $int_col_width; ?>%">
		      ...
		      <br />
		      <a href="javascript: nm_set_option('profile_new', '<?php echo $str_new_conn; ?>', '')" class="nmLinkData"><?php echo $str_new_conn; ?></a>
		     </td>
		<?php
		            $int_col_count++;
		...
		?>
		     <td class="nmOddText" style="padding: 4px 10px" colspan="<?php echo $int_colspan; ?>">&nbsp;</td>
		<?php
		            }
...
<table class="nmTable" style="width: 500px" align="center">
 <tr>
  <td class="nmTitle" colspan="2" style="white-space: nowrap"><?php echo $nm_lang['profile_general']; ?></td>
 </tr>
 <tr>
...
<?php
        ...
        {
?>
    <option value="<?php echo $str_dbms; ?>"<?php if ($str_dbms == $_SESSION['nm_session']['prod_v8']['profile']['dbms']) { echo ' selected="selected"'; } ?>><?php echo $nm_lang[$str_dbms]; ?></option>
<?php
        }
?>
   </select>
 ...
 <tr>
  ...
  <td class="nmLineV3">
   <select name="field_decimal" class="nmInput">
    <option value="."<?php  if ('.' == $_SESSION['nm_session']['prod_v8']['profile']['decimal']) { echo ' selected="selected"'; } ?>><?php echo $nm_lang['form_dec_dot'];   ?></option>
    <option value=","<?php  if (',' == $_SESSION['nm_session']['prod_v8']['profile']['decimal']) { echo ' selected="selected"'; } ?>><?php echo $nm_lang['form_dec_comma']; ?></option>
   </select>
  </td>
 </tr>
 <tr>
  ...
  <td class="nmLineV3">
   <select name="field_use_persistent" class="nmInput">
    <option value="Y"<?php  if ('Y' == $_SESSION['nm_session']['prod_v8']['profile']['use_persistent']) { echo ' selected="selected"'; } ?>><?php echo $nm_lang['form_persistente_y'];   ?></option>
    <option value="N"<?php  if ('N' == $_SESSION['nm_session']['prod_v8']['profile']['use_persistent'] || empty($_SESSION['nm_session']['prod_v8']['profile']['use_persistent'])) { echo ' selected="selected"'; } ?>><?php echo $nm_lang['form_persistente_n']; ?></option>
   </select>
  </td>
 </tr>
</table>
...
<input type="button" value="<?php echo $nm_lang['button_cancel'];   ?>" onClick="nm_set_option('main_menu', '', 'nm_iframe')" class="nmButton" />
</div>
<?php
} // nm_prod_display_profile_general
...
<br />
<input type="button" value="<?php echo $nm_lang['button_back']; ?>" onClick="nm_set_option('main_menu', '', 'nm_iframe')" class="nmButton" />
</div>
<?php
    }
    else
...
<table class="nmTable" style="width: 500px" align="center" cellpadding="3px">
 <tr>
  <td class="nmTitle" style="white-space: nowrap" colspan="5"><?php echo $nm_lang['profile_rename']; ?></td>
 </tr>
...
<input type="button" value="<?php echo $nm_lang['button_rename']; ?>" onclick="nm_set_option('profile_rename', '', 'nm_iframe')" class="nmButton" >
<input type="button" value="<?php echo $nm_lang['button_cancel']; ?>" onClick="nm_set_option('main_menu', '', '_top')" class="nmButton" />
</div>
<?php
    }
...
<br />
<input type="button" value="<?php echo $nm_lang['button_test'];   ?>" onClick="nm_test_conn()" class="nmButton" />
<input type="button" value="<?php echo $nm_lang['button_cancel']; ?>" onClick="nm_set_option('main_menu', '', 'nm_iframe')" class="nmButton" />
</div>
<?php
    }
