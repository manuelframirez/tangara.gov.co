  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fuente_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_fuente_mob_validate_id_municipio()
  {
    var nomeCampo_id_municipio = "id_municipio";
    var var_id_municipio = scAjaxGetFieldSelect(nomeCampo_id_municipio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fuente_mob_validate_id_municipio(var_id_municipio, var_script_case_init, do_ajax_form_fuente_mob_validate_id_municipio_cb);
  } // do_ajax_form_fuente_mob_validate_id_municipio

  function do_ajax_form_fuente_mob_validate_id_municipio_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fuente_mob_validate_id_municipio_cb

  // ---------- Validate id_indicador
  function do_ajax_form_fuente_mob_validate_id_indicador()
  {
    var nomeCampo_id_indicador = "id_indicador";
    var var_id_indicador = scAjaxGetFieldSelect(nomeCampo_id_indicador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fuente_mob_validate_id_indicador(var_id_indicador, var_script_case_init, do_ajax_form_fuente_mob_validate_id_indicador_cb);
  } // do_ajax_form_fuente_mob_validate_id_indicador

  function do_ajax_form_fuente_mob_validate_id_indicador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fuente_mob_validate_id_indicador_cb

  // ---------- Validate texto_fuente
  function do_ajax_form_fuente_mob_validate_texto_fuente()
  {
    var nomeCampo_texto_fuente = "texto_fuente";
    var var_texto_fuente = scAjaxGetFieldText(nomeCampo_texto_fuente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fuente_mob_validate_texto_fuente(var_texto_fuente, var_script_case_init, do_ajax_form_fuente_mob_validate_texto_fuente_cb);
  } // do_ajax_form_fuente_mob_validate_texto_fuente

  function do_ajax_form_fuente_mob_validate_texto_fuente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fuente_mob_validate_texto_fuente_cb
  // ---------- Form
  function do_ajax_form_fuente_mob_submit_form()
  {
    scAjaxHideMessage();
    var var_id_municipio = scAjaxGetFieldSelect("id_municipio");
    var var_id_indicador = scAjaxGetFieldSelect("id_indicador");
    var var_texto_fuente = scAjaxGetFieldText("texto_fuente");
    var var_id_fuente = scAjaxGetFieldText("id_fuente");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_fuente_mob_submit_form(var_id_municipio, var_id_indicador, var_texto_fuente, var_id_fuente, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_fuente_mob_submit_form_cb);
  } // do_ajax_form_fuente_mob_submit_form

  function do_ajax_form_fuente_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_fuente_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_fuente_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_fuente_mob_navigate_form(var_id_fuente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fuente_mob_navigate_form_cb);
  } // do_ajax_form_fuente_mob_navigate_form

  function do_ajax_form_fuente_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_fuente_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fuente_mob_navigate_form_cb
  ...
  ajax_field_list[0] = "id_municipio";
  ajax_field_list[1] = "id_indicador";
