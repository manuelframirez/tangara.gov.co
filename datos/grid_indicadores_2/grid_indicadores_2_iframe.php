...
$oExportPdf = new grid_indicadores_2_export_pdf;
$oExportPdf->exportPdf();

class grid_indicadores_2_export_pdf {
...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_titl'] ?> - indicadores :: PDF</title>
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_indicadores_2_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_indicadores_2']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_indicadores_2']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_indicadores_2.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_indicadores_2']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_indicadores_2']['pdf_name'] : "grid_indicadores_2.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
