<?php
   ...
   session_start();
    $Ord_Cmp = new grid_indicadores_2_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_indicadores_2_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["dimension_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['labels']["dimension_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['labels']["dimension_descripcion"] : "Descripcion";
   ...
   $tab_labels["tematica_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['labels']["tematica_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['labels']["tematica_descripcion"] : "Descripcion";
   ...
   $tab_labels["indicadores_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['labels']["indicadores_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['labels']["indicadores_nombre"] : "Nombre";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_indicadores_2']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_indicadores_2']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_indicadores_2']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       $ordem = (substr($campo_sort, 0, 1) == "+") ? "asc" : "desc";
       $campo = substr($campo_sort, 1);
       $_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['ordem_select'][$campo] = $ordem;
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - indicadores</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_indicadores_2_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_indicadores_2']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
