<?php
class form_datos_2_nivel_form extends form_datos_2_nivel_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['sc_redir_atualiz'] == 'ok')
{
?>
...
<?php
include_once("form_datos_2_nivel_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_datos_2_nivel_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['recarga'];
}
...
<?php
 include_once("form_datos_2_nivel_js0.php");
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['form_datos_2_nivel'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_datos_2_nivel'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bnovo", "do_ajax_form_datos_2_nivel_add_new_line(); return false;", "do_ajax_form_datos_2_nivel_add_new_line(); return false;", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_datos_2_nivel']['empty_filter'] = true;
       }
       echo "<tr><td>";
  }
?>
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['sc_field_0_']) && $this->nmgp_cmp_hidden['sc_field_0_'] == 'off') { $sStyleHidden_sc_field_0_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['sc_field_0_'])) {
          $this->nm_new_label['sc_field_0_'] = "Variable"; } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['id_variable_']) && $this->nmgp_cmp_hidden['id_variable_'] == 'off') { $sStyleHidden_id_variable_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['id_variable_'])) {
          $this->nm_new_label['id_variable_'] = "sub Variable"; } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_datos_2_nivel);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_datos_2_nivel = $this->form_vert_form_datos_2_nivel;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_datos_2_nivel))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_datos_2_nivel as $sc_seq_vert => $sc_lixo)
   {
       $this->tipo_dato_ = $this->form_vert_form_datos_2_nivel[$sc_seq_vert]['tipo_dato_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->id_datos_ = $this->form_vert_form_datos_2_nivel[$sc_seq_vert]['id_datos_']; 
       ...
       $this->valor_ = $this->form_vert_form_datos_2_nivel[$sc_seq_vert]['valor_']; 
       $valor_ = $this->valor_; 
       $sStyleHidden_valor_ = '';
       ...
       $this->id_categoria_ = $this->form_vert_form_datos_2_nivel[$sc_seq_vert]['id_categoria_']; 
       ...
       $this->id_municipio_ = $this->form_vert_form_datos_2_nivel[$sc_seq_vert]['id_municipio_']; 
       ...
       $this->id_variable_ = $this->form_vert_form_datos_2_nivel[$sc_seq_vert]['id_variable_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_datos_2_nivel_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_datos_2_nivel_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_datos_2_nivel_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_datos_2_nivel_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_datos_2_nivel_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_datos_2_nivel_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_datos_2_nivel = $guarda_form_vert_form_datos_2_nivel;
   } 
   if ($Table_refresh) 
   { 
...
?>
<script>
 parent.scAjaxDetailStatus("form_datos_2_nivel");
 parent.scAjaxDetailHeight("form_datos_2_nivel", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
